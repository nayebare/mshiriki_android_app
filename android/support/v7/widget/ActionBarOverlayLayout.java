...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C03281 extends ViewPropertyAnimatorListenerAdapter {
        C03281() {
        }
    ...
    static {
        ATTRS = new int[]{C0283R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03281();
        this.mRemoveActionBarHideOffset = new C03292();
        this.mAddActionBarHideOffset = new C03303();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0283R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0283R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0283R.id.action_bar));
        }
    }
