...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    class C03484 extends VpaListenerAdapter {
        ...
        public void onAnimationEnd(View view) {
            ...
            ViewCompat.setAlpha(view, TextTrackStyle.DEFAULT_FONT_SCALE);
    ...
    class C03528 extends VpaListenerAdapter {
        ...
        public void onAnimationEnd(View view) {
            ...
            ViewCompat.setAlpha(this.val$newView, TextTrackStyle.DEFAULT_FONT_SCALE);
    ...
    public void runPendingAnimations() {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (movesPending) {
                ...
                Runnable mover = new C03451(moves);
                if (removalsPending) {
            ...
            if (changesPending) {
                ...
                Runnable changer = new C03462(changes);
                if (removalsPending) {
            ...
            if (additionsPending) {
                ...
                Runnable adder = new C03473(additions);
    ...
    void animateAddImpl(ViewHolder holder) {
        ...
        animation.alpha(TextTrackStyle.DEFAULT_FONT_SCALE).setDuration(getAddDuration()).setListener(new C03495(holder, animation)).start();
    }
    ...
    void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(TextTrackStyle.DEFAULT_FONT_SCALE).setListener(new C03528(changeInfo, newViewAnimation, newView)).start();
        }
    }
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, ViewHolder item) {
        ...
        ViewCompat.setAlpha(item.itemView, TextTrackStyle.DEFAULT_FONT_SCALE);
    ...
    public void endAnimations() {
        ...
        for (i = this.mPendingAdditions.size() - 1; i >= 0; i--) {
            ...
            ViewCompat.setAlpha(item2.itemView, TextTrackStyle.DEFAULT_FONT_SCALE);
