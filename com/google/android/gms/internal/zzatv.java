...
public class zzatv extends zzats {
    ...
    class C10491 implements Runnable {
        ...
        C10491(zzatv com_google_android_gms_internal_zzatv, boolean z, zza com_google_android_gms_internal_zzatv_zza) {
    ...
    class C10502 implements Runnable {
        ...
        C10502(zzatv com_google_android_gms_internal_zzatv, zza com_google_android_gms_internal_zzatv_zza) {
            this.zzbuw = com_google_android_gms_internal_zzatv;
    ...
    private void zza(Activity activity, zza com_google_android_gms_internal_zzatv_zza, boolean z) {
        ...
        if (i != 0) {
            ...
            zza com_google_android_gms_internal_zzatv_zza2 = new zza(com_google_android_gms_internal_zzatv_zza);
            this.zzbun = this.zzbum;
            this.zzbuo = zznq().elapsedRealtime();
            this.zzbum = com_google_android_gms_internal_zzatv_zza2;
            zzJs().zzm(new C10491(this, z, com_google_android_gms_internal_zzatv_zza2));
        }
    }
