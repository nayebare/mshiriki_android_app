...
public abstract class OrientationHelper {
    ...
    static class C03601 extends OrientationHelper {
        C03601(LayoutManager layoutManager) {
            super(null);
        }
    ...
    static class C03612 extends OrientationHelper {
        C03612(LayoutManager layoutManager) {
            super(null);
        }
