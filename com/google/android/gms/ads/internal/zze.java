...
public class zze {
    ...
    public zze(Context context, @Nullable zza com_google_android_gms_internal_zzov_zza) {
        ...
        if (this.zzsQ.zzSi && this.zzsQ.zzSj != null) {
            for (String str2 : this.zzsQ.zzSj) {
                if (!TextUtils.isEmpty(str2)) {
                    zzv.zzcJ().zzc(this.mContext, BuildConfig.FLAVOR, str2.replace("{NAVIGATION_URL}", Uri.encode(str)));
                }
            }
        }
    }
