...
import android.support.v7.recyclerview.C0310R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        void setMeasuredDimensionFromChildren(int widthSpec, int heightSpec) {
            ...
            int minX = Strategy.TTL_SECONDS_INFINITE;
            int minY = Strategy.TTL_SECONDS_INFINITE;
        ...
        public void ignoreView(View view) {
            ...
            vh.addFlags(Cast.MAX_NAMESPACE_LENGTH);
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0310R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0310R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0310R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0310R.styleable.RecyclerView_reverseLayout, RecyclerView.POST_UPDATES_ON_ANIMATION);
            properties.stackFromEnd = a.getBoolean(C0310R.styleable.RecyclerView_stackFromEnd, RecyclerView.POST_UPDATES_ON_ANIMATION);
            a.recycle();
            return properties;
        }
    ...
    static class C03683 implements Interpolator {
        C03683() {
        }
    ...
    class C03694 implements ProcessCallback {
        C03694() {
        }
    ...
    class C03705 implements Callback {
        C03705() {
        }
        ...
        public void detachViewFromParent(int offset) {
            ...
            if (view != null) {
                ...
                if (vh != null) {
                    if (!vh.isTmpDetached() || vh.shouldIgnore()) {
                        vh.addFlags(FileUploadPreferences.BATTERY_USAGE_UNRESTRICTED);
                    } else {
    ...
    class C03716 implements Callback {
        C03716() {
        }
    ...
    public final class Recycler {
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (fromScrapOrHiddenOrCache && !RecyclerView.this.mState.isPreLayout() && holder.hasAnyOfTheFlags(AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD)) {
                holder.setFlags(RecyclerView.TOUCH_SLOP_DEFAULT, AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD);
                if (RecyclerView.this.mState.mRunSimpleAnimations) {
                    RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(holder, RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, holder, ItemAnimator.buildAdapterChangeFlagsForAnimations(holder) | Connections.MAX_RELIABLE_MESSAGE_LEN, holder.getUnmodifiedPayloads()));
                }
            }
        ...
        void setAdapterPositionsAsUnknown() {
            ...
            for (int i = RecyclerView.TOUCH_SLOP_DEFAULT; i < cachedCount; i += RecyclerView.VERTICAL) {
                ViewHolder holder = (ViewHolder) this.mCachedViews.get(i);
                if (holder != null) {
                    holder.addFlags(AdRequest.MAX_CONTENT_URL_LENGTH);
                }
            }
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C03721 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03721() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C03721());
        }
    }
    ...
    class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            float distance = ((float) halfContainerSize) + (((float) halfContainerSize) * distanceInfluenceForSnapDuration(Math.min(TextTrackStyle.DEFAULT_FONT_SCALE, (TextTrackStyle.DEFAULT_FONT_SCALE * ((float) delta)) / ((float) containerSize))));
            if (velocity > 0) {
                ...
                duration = (int) (((((float) absDx) / ((float) containerSize)) + TextTrackStyle.DEFAULT_FONT_SCALE) * 300.0f);
            }
    ...
    static {
        ...
        sQuinticInterpolator = new C03683();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03661();
        ...
        this.mItemAnimatorRunner = new C03672();
        this.mViewInfoProcessCallback = new C03694();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0310R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0310R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0310R.styleable.RecyclerView_android_descendantFocusability, NO_POSITION) == NO_POSITION) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03705());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03716());
    }
    ...
    private void pullGlows(float x, float overscrollX, float y, float overscrollY) {
        ...
        if (overscrollX < 0.0f) {
            ensureLeftGlow();
            if (this.mLeftGlow.onPull((-overscrollX) / ((float) getWidth()), TextTrackStyle.DEFAULT_FONT_SCALE - (y / ((float) getHeight())))) {
                invalidate = true;
            }
        ...
        if (overscrollY < 0.0f) {
            ...
            ensureBottomGlow();
            if (this.mBottomGlow.onPull(overscrollY / ((float) getHeight()), TextTrackStyle.DEFAULT_FONT_SCALE - (x / ((float) getWidth())))) {
                invalidate = true;
            }
        }
    ...
    private void recoverFocusFromState() {
        if (this.mPreserveFocusAfterLayout && this.mAdapter != null && hasFocus() && getDescendantFocusability() != 393216) {
            if (getDescendantFocusability() != MetadataChangeSet.INDEXABLE_TEXT_SIZE_LIMIT_BYTES || !isFocused()) {
                if (!isFocused()) {
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (i = TOUCH_SLOP_DEFAULT; i < this.mChildHelper.getChildCount(); i += VERTICAL) {
                ...
                if (!(viewHolder.shouldIgnore() || this.mViewInfoStore.isInPreLayout(viewHolder))) {
                    ...
                    if (!wasHidden) {
                        flags |= Connections.MAX_RELIABLE_MESSAGE_LEN;
                    }
    ...
    private void findMinMaxChildLayoutPositions(int[] into) {
        ...
        int minPositionPreLayout = Strategy.TTL_SECONDS_INFINITE;
