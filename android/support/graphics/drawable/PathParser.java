    ...
    public static class PathDataNode {
        ...
        public void interpolatePathDataNode(PathDataNode nodeFrom, PathDataNode nodeTo, float fraction) {
            for (int i = 0; i < nodeFrom.params.length; i++) {
                this.params[i] = (nodeFrom.params[i] * (TextTrackStyle.DEFAULT_FONT_SCALE - fraction)) + (nodeTo.params[i] * fraction);
            }
        }
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                ...
                case C0308R.styleable.AppCompatTheme_textColorAlertDialogListItem /*97*/:
                    incr = 7;
                    break;
                case C0308R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*67*/:
                case C0308R.styleable.AppCompatTheme_buttonBarNegativeButtonStyle /*99*/:
                    incr = 6;
                    break;
                ...
                case C0308R.styleable.AppCompatTheme_checkboxStyle /*104*/:
                case 'v':
                    incr = 1;
                    break;
                ...
                case C0308R.styleable.AppCompatTheme_switchStyle /*113*/:
                case 's':
                    incr = 4;
                    break;
