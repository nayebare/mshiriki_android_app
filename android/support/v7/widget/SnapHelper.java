...
public abstract class SnapHelper extends OnFlingListener {
    ...
    class C03851 extends OnScrollListener {
        boolean mScrolled;
    ...
    class C03862 extends LinearSmoothScroller {
        C03862(Context context) {
            super(context);
        }
    ...
    public SnapHelper() {
        this.mScrollListener = new C03851();
    }
    ...
    public int[] calculateScrollDistance(int velocityX, int velocityY) {
        outDist = new int[2];
        this.mGravityScroller.fling(0, 0, velocityX, velocityY, Target.SIZE_ORIGINAL, Strategy.TTL_SECONDS_INFINITE, Target.SIZE_ORIGINAL, Strategy.TTL_SECONDS_INFINITE);
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        if (layoutManager instanceof ScrollVectorProvider) {
            return new C03862(this.mRecyclerView.getContext());
        }
        return null;
    }
}
