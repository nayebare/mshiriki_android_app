...
public class PagerSnapHelper extends SnapHelper {
    ...
    class C03621 extends LinearSmoothScroller {
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        if (layoutManager instanceof ScrollVectorProvider) {
            return new C03621(this.mRecyclerView.getContext());
        }
        return null;
    }
    ...
    private View findCenterView(LayoutManager layoutManager, OrientationHelper helper) {
        ...
        int absClosest = Strategy.TTL_SECONDS_INFINITE;
    ...
    private View findStartView(LayoutManager layoutManager, OrientationHelper helper) {
        ...
        View closestChild = null;
        int startest = Strategy.TTL_SECONDS_INFINITE;
        for (int i = 0; i < childCount; i++) {
            View child = layoutManager.getChildAt(i);
