...
public class zzy extends Thread implements OnFrameAvailableListener, zza {
    private static final float[] zzNO;
    ...
    static {
        zzNO = new float[]{PlayerStats.UNSET_VALUE, PlayerStats.UNSET_VALUE, PlayerStats.UNSET_VALUE, TextTrackStyle.DEFAULT_FONT_SCALE, PlayerStats.UNSET_VALUE, PlayerStats.UNSET_VALUE, PlayerStats.UNSET_VALUE, TextTrackStyle.DEFAULT_FONT_SCALE, PlayerStats.UNSET_VALUE, TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE, PlayerStats.UNSET_VALUE};
    }

    public zzy(Context context) {
        super("SphericalVideoProcessor");
        this.zzOe = ByteBuffer.allocateDirect(zzNO.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
    ...
    public void run() {
        Object obj = 1;
        if (this.zzOa == null) {
            zzpy.m25e("SphericalVideoProcessor started with no output texture.");
            this.zzOf.countDown();
            return;
        }
        boolean zzhV = zzhV();
    ...
    int zzhT() {
        ...
        GLES20.glUniformMatrix3fv(this.zzOc, 1, false, new float[]{TextTrackStyle.DEFAULT_FONT_SCALE, 0.0f, 0.0f, 0.0f, TextTrackStyle.DEFAULT_FONT_SCALE, 0.0f, 0.0f, 0.0f, TextTrackStyle.DEFAULT_FONT_SCALE}, 0);
