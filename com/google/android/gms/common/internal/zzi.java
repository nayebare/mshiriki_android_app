...
public abstract class zzi implements OnClickListener {
    ...
    class C06361 extends zzi {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ int val$requestCode;

        C06361(Intent intent, Activity activity, int i) {
    ...
    class C06372 extends zzi {
        final /* synthetic */ Fragment val$fragment;
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ int val$requestCode;

        C06372(Intent intent, Fragment fragment, int i) {
            this.val$intent = intent;
    ...
    class C06383 extends zzi {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ int val$requestCode;
        final /* synthetic */ zzaax zzaEh;

        C06383(Intent intent, zzaax com_google_android_gms_internal_zzaax, int i) {
            this.val$intent = intent;
