...
public class zzatp {
    ...
    class C10281 implements Runnable {
        ...
        C10281(zzatp com_google_android_gms_internal_zzatp) {
    ...
    class C10292 implements Callable<String> {
        final /* synthetic */ String zzbky;
        final /* synthetic */ zzatp zzbtH;

        C10292(zzatp com_google_android_gms_internal_zzatp, String str) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
            this.zzbky = str;
        }
    ...
    class C10303 implements Callable<String> {
        final /* synthetic */ String zzbky;
        final /* synthetic */ zzatp zzbtH;

        C10303(zzatp com_google_android_gms_internal_zzatp, String str) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
            this.zzbky = str;
        }
    ...
    class C10314 implements zza {
        final /* synthetic */ zzatp zzbtH;

        C10314(zzatp com_google_android_gms_internal_zzatp) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
        }
    ...
    class C10325 implements zza {
        final /* synthetic */ zzatp zzbtH;

        C10325(zzatp com_google_android_gms_internal_zzatp) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
        }
    ...
    zzatp(zzatt com_google_android_gms_internal_zzatt) {
        ...
        this.zzbtg.zzm(new C10281(this));
    }
        ...
        if (zzLn == null) {
            ...
            if (!zzn.isEmpty()) {
                ...
                try {
                    ...
                    zzLy().zza(zzKG, url, zza, null, new C10314(this));
    ...
    void zza(zzasx com_google_android_gms_internal_zzasx, zzasq com_google_android_gms_internal_zzasq) {
        ...
        com_google_android_gms_internal_zzauh_zze.zzbwk = SystemMediaRouteProvider.PACKAGE_NAME;
    ...
    void zzb(zzasp com_google_android_gms_internal_zzasp) {
        ...
        try {
            ...
            zzLy().zza(com_google_android_gms_internal_zzasp.zzjI(), url, map, new C10325(this));
        } catch (MalformedURLException e) {
    ...
    void zzb(zzasq com_google_android_gms_internal_zzasq, long j) {
        ...
        if (getContext().getPackageManager() == null) {
            ...
            if (applicationInfo != null) {
                ...
                if ((applicationInfo.flags & Cast.MAX_NAMESPACE_LENGTH) != 0) {
    ...
    void zzb(zzatb com_google_android_gms_internal_zzatb, zzasq com_google_android_gms_internal_zzasq) {
        ...
        if (!com_google_android_gms_internal_zzasq.zzbqk && !"_in".equals(com_google_android_gms_internal_zzatb.name)) {
            ...
            try {
                Bundle zzKY = com_google_android_gms_internal_zzatb.zzbqP.zzKY();
                zzf(com_google_android_gms_internal_zzasq);
                if ("_iap".equals(com_google_android_gms_internal_zzatb.name) || "ecommerce_purchase".equals(com_google_android_gms_internal_zzatb.name)) {
                    long round;
                    Object string = zzKY.getString("currency");
                    if ("ecommerce_purchase".equals(com_google_android_gms_internal_zzatb.name)) {
                        double d = zzKY.getDouble("value") * 1000000.0d;
                        if (d == 0.0d) {
                            d = ((double) zzKY.getLong("value")) * 1000000.0d;
                        }
