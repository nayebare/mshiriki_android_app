...
public class zzu extends com.google.android.gms.internal.zzep.zza {
    ...
    class C05261 extends WebViewClient {
        ...
        C05261(zzu com_google_android_gms_ads_internal_zzu) {
    ...
    class C05272 implements OnTouchListener {
        final /* synthetic */ zzu zzus;

        C05272(zzu com_google_android_gms_ads_internal_zzu) {
            this.zzus = com_google_android_gms_ads_internal_zzu;
        }
    ...
    class C05283 implements Callable<zzch> {
        final /* synthetic */ zzu zzus;

        C05283(zzu com_google_android_gms_ads_internal_zzu) {
            this.zzus = com_google_android_gms_ads_internal_zzu;
        }
    ...
    private void zzcw() {
        ...
        this.zzup.setWebViewClient(new C05261(this));
        this.zzup.setOnTouchListener(new C05272(this));
    }

    private Future<zzch> zzcz() {
        return zzph.zza(new C05283(this));
    }
