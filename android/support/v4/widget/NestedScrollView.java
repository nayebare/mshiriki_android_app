...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild, ScrollingView {
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C02251 implements Creator<SavedState> {
            C02251() {
            }
                        ...
                        if (!dispatchNestedScroll(0, scrolledDeltaY, 0, deltaY - scrolledDeltaY, this.mScrollOffset)) {
                            if (canOverscroll) {
                                ...
                                if (pulledToY < 0) {
                                    ...
                                    this.mEdgeGlowBottom.onPull(((float) deltaY) / ((float) getHeight()), TextTrackStyle.DEFAULT_FONT_SCALE - (ev.getX(activePointerIndex) / ((float) getWidth())));
