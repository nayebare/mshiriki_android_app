    ...
    private static ColorStateList inflate(@NonNull Resources r, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (depth < innerDepth && type == 3) {
                ...
                TypedArray a = obtainAttributes(r, theme, attrs, C0283R.styleable.ColorStateListItem);
                int baseColor = a.getColor(C0283R.styleable.ColorStateListItem_android_color, -65281);
                float alphaMod = TextTrackStyle.DEFAULT_FONT_SCALE;
                if (a.hasValue(C0283R.styleable.ColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(C0283R.styleable.ColorStateListItem_android_alpha, TextTrackStyle.DEFAULT_FONT_SCALE);
                } else {
                    if (a.hasValue(C0283R.styleable.ColorStateListItem_alpha)) {
                        alphaMod = a.getFloat(C0283R.styleable.ColorStateListItem_alpha, TextTrackStyle.DEFAULT_FONT_SCALE);
                    }
                }
                a.recycle();
                ...
                while (i < numAttrs) {
                    ...
                    if (stateResId == 16843173 || stateResId == 16843551 || stateResId == C0283R.attr.alpha) {
                        j2 = j;
                    } else {
                        j2 = j + 1;
