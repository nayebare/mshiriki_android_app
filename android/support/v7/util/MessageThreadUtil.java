...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C03161 implements MainThreadCallback<T> {
        ...
        class C03151 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C03161.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C03161.UPDATE_ITEM_COUNT /*1*/:
                            C03161.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C03161.ADD_TILE /*2*/:
                            C03161.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C03161.REMOVE_TILE /*3*/:
                            C03161.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C03161.this.mQueue.next();
                }
            }
        }

        C03161(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C03151();
        }
    ...
    class C03182 implements BackgroundCallback<T> {
        ...
        C03182(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C03171();
        }
