...
public class zzabj extends zzaxr implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    class C08971 implements Runnable {
        ...
        C08971(zzabj com_google_android_gms_internal_zzabj, zzayb com_google_android_gms_internal_zzayb) {
    ...
    public void zzb(zzayb com_google_android_gms_internal_zzayb) {
        this.mHandler.post(new C08971(this, com_google_android_gms_internal_zzayb));
    }
