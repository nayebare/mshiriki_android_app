...
public class zzab {
    ...
    class C06342 implements com.google.android.gms.common.api.PendingResult.zza {
        ...
        C06342(PendingResult pendingResult, TaskCompletionSource taskCompletionSource, zza com_google_android_gms_common_internal_zzab_zza, zzb com_google_android_gms_common_internal_zzab_zzb) {
    ...
    class C06353 implements zza<R, T> {
        final /* synthetic */ zze zzaFe;

        C06353(zze com_google_android_gms_common_api_zze) {
    ...
    public static <R extends Result, T extends zze<R>> Task<T> zza(PendingResult<R> pendingResult, T t) {
        return zza((PendingResult) pendingResult, new C06353(t));
    }
    ...
    public static <R extends Result, T> Task<T> zza(PendingResult<R> pendingResult, zza<R, T> com_google_android_gms_common_internal_zzab_zza_R__T, zzb com_google_android_gms_common_internal_zzab_zzb) {
        ...
        pendingResult.zza(new C06342(pendingResult, taskCompletionSource, com_google_android_gms_common_internal_zzab_zza_R__T, com_google_android_gms_common_internal_zzab_zzb));
