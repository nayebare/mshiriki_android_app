...
public class BasicNetwork implements Network {
    ...
    L_0x0004:
        ...
        r21 = new java.util.HashMap;	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        ...
        r3 = r27.getCacheEntry();	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r0 = r26;
        r1 = r21;
        ...
        r0 = r26;
        r3 = r0.mHttpStack;	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r0 = r27;
        r1 = r21;
        r22 = r3.performRequest(r0, r1);	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r12 = r22.getStatusLine();	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r14 = r12.getStatusCode();	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r3 = r22.getAllHeaders();	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r6 = convertHeaders(r3);	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r3 = 304; // 0x130 float:4.26E-43 double:1.5E-321;
        if (r14 != r3) goto L_0x0075;
    L_0x003c:
        r20 = r27.getCacheEntry();	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        if (r20 != 0) goto L_0x0054;
    L_0x0042:
        r3 = new com.android.volley.NetworkResponse;	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r4 = 304; // 0x130 float:4.26E-43 double:1.5E-321;
        r5 = 0;
        r7 = 1;
        r16 = android.os.SystemClock.elapsedRealtime();	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r8 = r16 - r24;
    ...
    L_0x0054:
        r0 = r20;
        r3 = r0.responseHeaders;	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        ...
        r7 = new com.android.volley.NetworkResponse;	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r8 = 304; // 0x130 float:4.26E-43 double:1.5E-321;
        r0 = r20;
        r9 = r0.data;	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r0 = r20;
        r10 = r0.responseHeaders;	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r11 = 1;
        r4 = android.os.SystemClock.elapsedRealtime();	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r12 = r4 - r24;
        ...
        goto L_0x0053;
    L_0x0075:
        r3 = r22.getEntity();	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        if (r3 == 0) goto L_0x00af;
    L_0x007b:
        r3 = r22.getEntity();	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        r0 = r26;
        r11 = r0.entityToBytes(r3);	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
    L_0x0085:
        r4 = android.os.SystemClock.elapsedRealtime();	 Catch:{ SocketTimeoutException -> 0x00a0, ConnectTimeoutException -> 0x015d, MalformedURLException -> 0x015a, IOException -> 0x0158 }
        r8 = r4 - r24;
        r7 = r26;
        r10 = r27;
    ...
    L_0x009a:
        r3 = new java.io.IOException;	 Catch:{ SocketTimeoutException -> 0x00a0, ConnectTimeoutException -> 0x015d, MalformedURLException -> 0x015a, IOException -> 0x0158 }
    ...
    L_0x00af:
        r3 = 0;
        r11 = new byte[r3];	 Catch:{ SocketTimeoutException -> 0x0160, ConnectTimeoutException -> 0x00c5, MalformedURLException -> 0x00d6, IOException -> 0x00f9 }
        goto L_0x0085;
    L_0x00b3:
        r13 = new com.android.volley.NetworkResponse;	 Catch:{ SocketTimeoutException -> 0x00a0, ConnectTimeoutException -> 0x015d, MalformedURLException -> 0x015a, IOException -> 0x0158 }
        r17 = 0;
        r4 = android.os.SystemClock.elapsedRealtime();	 Catch:{ SocketTimeoutException -> 0x00a0, ConnectTimeoutException -> 0x015d, MalformedURLException -> 0x015a, IOException -> 0x0158 }
        r18 = r4 - r24;
        r15 = r11;
