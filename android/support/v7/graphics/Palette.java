...
public final class Palette {
    ...
    static class C02861 implements Filter {
    ...
    public static final class Builder {
        ...
        class C02871 extends AsyncTask<Bitmap, Void, Palette> {
            final /* synthetic */ PaletteAsyncListener val$listener;

            C02871(PaletteAsyncListener paletteAsyncListener) {
        ...
        public AsyncTask<Bitmap, Void, Palette> generate(PaletteAsyncListener listener) {
            ...
            return AsyncTaskCompat.executeParallel(new C02871(listener), this.mBitmap);
        }
