...
public class zzaze {
    ...
    private final zzbgc zzbIm;
    private final zzbgc zzbIn;
    private final Set<String> zzbIo;
    private zzbdp zzbIp;
    private zzaym zzbIq;
    ...
    class C11181 implements zzc {
        final /* synthetic */ zzaze zzbIs;

        C11181(zzaze com_google_android_gms_internal_zzaze) {
    ...
    private class zza implements com.google.android.gms.internal.zzbdb.zza {
        ...
        public Object zze(String str, Map<String, Object> map) {
            try {
                ...
                zzayx.m23e(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2));
            }
            return null;
        }
    }
    ...
    public zzaze(Context context, String str, zzbfr com_google_android_gms_internal_zzbfr, zzbfu com_google_android_gms_internal_zzbfu, zzbb com_google_android_gms_tagmanager_zzbb, zzay com_google_android_gms_tagmanager_zzay) {
        this.zzbIl = new zzazg();
        this.zzbIm = new zzbgc(new HashMap(50));
        this.zzbIn = new zzbgc(new HashMap(10));
        this.zzbIo = new HashSet();
        this.zzbIr = new C11181(this);
    ...
    private String zzC(String str, int i) {
        switch (i) {
            case C0473R.styleable.MapAttrs_uiZoomGestures /*12*/:
                return zzhO(str);
            default:
                zzayx.m23e("Unsupported Value Escaping: " + i);
                return str;
        }
    }
    ...
    private void zzQG() {
        ...
        this.zzbIm.zzc(NotificationCompatApi24.CATEGORY_EVENT, new zzbfz(new zzbdo()));
    ...
    private zzbfw zzao(Map<String, zzbfw<?>> map) {
        if (map == null) {
            zzayx.m23e("Cannot access the function parameters.");
            return zzbga.zzbKV;
        }
        ...
        if (com_google_android_gms_internal_zzbfw instanceof zzbge) {
            ...
            if (this.zzbIl.has(str)) {
                ...
                zzayx.m23e(new StringBuilder(String.valueOf(str).length() + 30).append("functionId '").append(str).append("' is not supported").toString());
                return zzbga.zzbKV;
            }
            if (com_google_android_gms_internal_zzbgd == null) {
                zzayx.m23e("Internal error: failed to convert function to a valid statement");
                return zzbga.zzbKV;
            }
            String str2 = "Executing: ";
            str = String.valueOf(com_google_android_gms_internal_zzbgd.zzRR());
            zzayx.m24v(str.length() != 0 ? str2.concat(str) : new String(str2));
            ...
            zzayx.m23e("No function id in properties");
            return zzbga.zzbKV;
        }
    }
    ...
    private zzbfw<?> zzhM(String str) {
        ...
        zzayx.m24v(new StringBuilder((String.valueOf(valueOf).length() + 31) + String.valueOf(str).length()).append(valueOf).append("Beginning to evaluate variable ").append(str).toString());
        ...
        valueOf2 = String.valueOf(zzPK());
        zzayx.m24v(new StringBuilder((String.valueOf(valueOf2).length() + 25) + String.valueOf(str).length()).append(valueOf2).append("Done evaluating variable ").append(str).toString());
        this.zzbFM--;
        this.zzbIo.remove(str);
        return zzao;
    }
    ...
    private zzbgd zzi(String str, Map<String, zzbfw<?>> map) {
        try {
            ...
            String valueOf = String.valueOf(e.getMessage());
            zzayx.m23e(new StringBuilder((String.valueOf(str).length() + 30) + String.valueOf(valueOf).length()).append("Incorrect keys for function ").append(str).append(". ").append(valueOf).toString());
            return null;
        }
    }
    ...
    zzbfw<?> zza(zzbft com_google_android_gms_internal_zzbft, Map<zzbfs, zzbfw<?>> map) {
        ...
        zzayx.m24v(new StringBuilder(String.valueOf(valueOf).length() + 19).append("Evaluating trigger ").append(valueOf).toString());
    ...
    zzbfw<?> zzb(zzbfs com_google_android_gms_internal_zzbfs) {
        ...
        try {
            ...
            zzayx.m23e("Predicate must return a boolean value");
            return new zzbfx(Boolean.valueOf(false));
        } catch (IllegalStateException e) {
            zzayx.m23e("Error evaluating predicate.");
            return zzbga.zzbKU;
        }
    }
    ...
    public void zzb(zzaym com_google_android_gms_internal_zzaym) {
        ...
        for (zzbft com_google_android_gms_internal_zzbft : this.zzbIk.zzRr()) {
            ...
            if (com_google_android_gms_internal_zzbft.zzRx().isEmpty() && com_google_android_gms_internal_zzbft.zzRy().isEmpty()) {
                ...
                zzayx.m24v(new StringBuilder(String.valueOf(valueOf2).length() + 64).append("Trigger is not being evaluated since it has no associated tags: ").append(valueOf2).toString());
            } else {
                ...
                if (zza == zzbga.zzbKU) {
                    ...
                    if (!com_google_android_gms_internal_zzbft.zzRy().isEmpty()) {
                        ...
                        zzayx.m24v(new StringBuilder(String.valueOf(valueOf).length() + 15).append("Blocking tags: ").append(valueOf).toString());
                        hashSet2.addAll(com_google_android_gms_internal_zzbft.zzRy());
                    }
                } else if (((Boolean) ((zzbfx) zza).zzRF()).booleanValue()) {
                    valueOf = String.valueOf(com_google_android_gms_internal_zzbft);
                    zzayx.m24v(new StringBuilder(String.valueOf(valueOf).length() + 19).append("Trigger is firing: ").append(valueOf).toString());
                    if (!com_google_android_gms_internal_zzbft.zzRx().isEmpty()) {
                        valueOf = String.valueOf(com_google_android_gms_internal_zzbft.zzRx());
                        zzayx.m24v(new StringBuilder(String.valueOf(valueOf).length() + 34).append("Adding tags to firing candidates: ").append(valueOf).toString());
                        hashSet.addAll(com_google_android_gms_internal_zzbft.zzRx());
                    }
                    if (!com_google_android_gms_internal_zzbft.zzRy().isEmpty()) {
                        valueOf = String.valueOf(com_google_android_gms_internal_zzbft.zzRy());
                        zzayx.m24v(new StringBuilder(String.valueOf(valueOf).length() + 24).append("Blocking disabled tags: ").append(valueOf).toString());
                        hashSet2.addAll(com_google_android_gms_internal_zzbft.zzRy());
                    }
                }
            }
        ...
        for (zzbfs com_google_android_gms_internal_zzbfs : hashSet) {
            ...
            zzayx.m24v(new StringBuilder(String.valueOf(valueOf3).length() + 21).append("Executing firing tag ").append(valueOf3).toString());
            try {
                ...
                if (zza(com_google_android_gms_internal_zzbfs)) {
                    ...
                    zzayx.m24v(new StringBuilder(String.valueOf(valueOf2).length() + 36).append("Tag configured to dispatch on fire: ").append(valueOf2).toString());
                }
                obj2 = obj;
            } catch (IllegalStateException e) {
                valueOf3 = "Error firing tag: ";
                valueOf2 = String.valueOf(e.getMessage());
                zzayx.m23e(valueOf2.length() != 0 ? valueOf3.concat(valueOf2) : new String(valueOf3));
                obj2 = obj;
            }
            obj = obj2;
        }
        ...
        if (com_google_android_gms_internal_zzaym.zzQs()) {
            ...
            zzayx.m24v(new StringBuilder(String.valueOf(valueOf2).length() + 35).append("Log passthrough event ").append(valueOf2).append(" to Firebase.").toString());
            try {
                ...
                zzayx.m23e(valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf));
            }
        } else {
            valueOf2 = String.valueOf(com_google_android_gms_internal_zzaym.zzQp());
            zzayx.m24v(new StringBuilder(String.valueOf(valueOf2).length() + 63).append("Non-passthrough event ").append(valueOf2).append(" doesn't get logged to Firebase directly.").toString());
        }
        if (obj != null) {
            zzayx.m24v("Dispatch called for dispatchOnFire tags.");
            dispatch();
        }
    }
