...
final class CollapsingTextHelper {
    ...
    void setCollapsedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), resId, C0283R.styleable.TextAppearance);
        if (a.hasValue(C0283R.styleable.TextAppearance_android_textColor)) {
            this.mCollapsedTextColor = a.getColorStateList(C0283R.styleable.TextAppearance_android_textColor);
        }
        if (a.hasValue(C0283R.styleable.TextAppearance_android_textSize)) {
            this.mCollapsedTextSize = (float) a.getDimensionPixelSize(C0283R.styleable.TextAppearance_android_textSize, (int) this.mCollapsedTextSize);
        }
        this.mCollapsedShadowColor = a.getInt(C0283R.styleable.TextAppearance_android_shadowColor, 0);
        this.mCollapsedShadowDx = a.getFloat(C0283R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.mCollapsedShadowDy = a.getFloat(C0283R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.mCollapsedShadowRadius = a.getFloat(C0283R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
    ...
    void setExpandedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), resId, C0283R.styleable.TextAppearance);
        if (a.hasValue(C0283R.styleable.TextAppearance_android_textColor)) {
            this.mExpandedTextColor = a.getColorStateList(C0283R.styleable.TextAppearance_android_textColor);
        }
        if (a.hasValue(C0283R.styleable.TextAppearance_android_textSize)) {
            this.mExpandedTextSize = (float) a.getDimensionPixelSize(C0283R.styleable.TextAppearance_android_textSize, (int) this.mExpandedTextSize);
        }
        this.mExpandedShadowColor = a.getInt(C0283R.styleable.TextAppearance_android_shadowColor, 0);
        this.mExpandedShadowDx = a.getFloat(C0283R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.mExpandedShadowDy = a.getFloat(C0283R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.mExpandedShadowRadius = a.getFloat(C0283R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
        if (VERSION.SDK_INT >= 16) {
    ...
    void setExpansionFraction(float fraction) {
        fraction = MathUtils.constrain(fraction, 0.0f, (float) TextTrackStyle.DEFAULT_FONT_SCALE);
    ...
    private void calculateBaseOffsets() {
        ...
        switch (collapsedAbsGravity & C0308R.styleable.AppCompatTheme_spinnerStyle) {
        ...
        switch (expandedAbsGravity & C0308R.styleable.AppCompatTheme_spinnerStyle) {
            case C0308R.styleable.AppCompatTheme_spinnerDropDownItemStyle /*48*/:
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTextToDraw != null && this.mDrawTitle) {
            ...
            if (this.mScale != TextTrackStyle.DEFAULT_FONT_SCALE) {
    ...
    private void setInterpolatedTextSize(float textSize) {
        ...
        boolean z = USE_SCALING_TEXTURE && this.mScale != TextTrackStyle.DEFAULT_FONT_SCALE;
        this.mUseTexture = z;
        if (this.mUseTexture) {
    ...
    private void calculateUsingTextSize(float textSize) {
        ...
        if (this.mText != null) {
            ...
            if (isClose(textSize, this.mCollapsedTextSize)) {
                ...
                this.mScale = TextTrackStyle.DEFAULT_FONT_SCALE;
    ...
    private static int blendColors(int color1, int color2, float ratio) {
        float inverseRatio = TextTrackStyle.DEFAULT_FONT_SCALE - ratio;
