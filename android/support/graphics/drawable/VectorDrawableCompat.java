...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VFullPath extends VPath {
        ...
        public VFullPath() {
            ...
            this.mStrokeAlpha = TextTrackStyle.DEFAULT_FONT_SCALE;
            this.mFillAlpha = TextTrackStyle.DEFAULT_FONT_SCALE;
            this.mTrimPathStart = 0.0f;
            this.mTrimPathEnd = TextTrackStyle.DEFAULT_FONT_SCALE;
    ...
    private static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int w, int h, ColorFilter filter) {
            ...
            if (matrixScale != 0.0f) {
                ...
                if (!(fullPath.mTrimPathStart == 0.0f && fullPath.mTrimPathEnd == TextTrackStyle.DEFAULT_FONT_SCALE)) {
                    float start = (fullPath.mTrimPathStart + fullPath.mTrimPathOffset) % TextTrackStyle.DEFAULT_FONT_SCALE;
                    float end = (fullPath.mTrimPathEnd + fullPath.mTrimPathOffset) % TextTrackStyle.DEFAULT_FONT_SCALE;
        ...
        private float getMatrixScale(Matrix groupStackedMatrix) {
            float[] unitVectors = new float[]{0.0f, TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE, 0.0f};
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTmpBounds.width() > 0 && this.mTmpBounds.height() > 0) {
            ...
            if (!(canvasSkewX == 0.0f && canvasSkewY == 0.0f)) {
                canvasScaleX = TextTrackStyle.DEFAULT_FONT_SCALE;
                canvasScaleY = TextTrackStyle.DEFAULT_FONT_SCALE;
            }
            ...
            if (scaledWidth > 0 && scaledHeight > 0) {
                ...
                if (needMirroring()) {
                    ...
                    canvas.scale(PlayerStats.UNSET_VALUE, TextTrackStyle.DEFAULT_FONT_SCALE);
                }
