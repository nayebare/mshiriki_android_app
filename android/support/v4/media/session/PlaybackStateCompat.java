...
public final class PlaybackStateCompat implements Parcelable {
    ...
    static class C01731 implements Creator<PlaybackStateCompat> {
        C01731() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        static class C01741 implements Creator<CustomAction> {
            C01741() {
            }
    ...
    public static PlaybackStateCompat fromPlaybackState(Object stateObj) {
        ...
        PlaybackStateCompat state = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(stateObj), PlaybackStateCompatApi21.getPosition(stateObj), PlaybackStateCompatApi21.getBufferedPosition(stateObj), PlaybackStateCompatApi21.getPlaybackSpeed(stateObj), PlaybackStateCompatApi21.getActions(stateObj), STATE_NONE, PlaybackStateCompatApi21.getErrorMessage(stateObj), PlaybackStateCompatApi21.getLastPositionUpdateTime(stateObj), customActions, PlaybackStateCompatApi21.getActiveQueueItemId(stateObj), VERSION.SDK_INT >= 22 ? PlaybackStateCompatApi22.getExtras(stateObj) : null);
