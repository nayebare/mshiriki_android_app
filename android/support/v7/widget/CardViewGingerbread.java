...
class CardViewGingerbread implements CardViewImpl {
    ...
    class C03431 implements RoundRectHelper {
        C03431() {
        }
        ...
        public void drawRoundRect(Canvas canvas, RectF bounds, float cornerRadius, Paint paint) {
            ...
            if (cornerRadius >= TextTrackStyle.DEFAULT_FONT_SCALE) {
                ...
                canvas.drawRect((bounds.left + roundedCornerRadius) - TextTrackStyle.DEFAULT_FONT_SCALE, bounds.bottom - roundedCornerRadius, TextTrackStyle.DEFAULT_FONT_SCALE + (bounds.right - roundedCornerRadius), bounds.bottom, paint);
            }
    ...
    public void initStatic() {
        RoundRectDrawableWithShadow.sRoundRectHelper = new C03431();
    }
