...
public class zzazs extends zzazv {
    ...
    public zzbfw<?> zza(zzazg com_google_android_gms_internal_zzazg, zzbfw<?>... com_google_android_gms_internal_zzbfw_Arr) {
        try {
            ...
            zzayx.m23e(new StringBuilder((String.valueOf(str).length() + 33) + String.valueOf(valueOf).length()).append("Internal error - Function call: ").append(str).append("\n").append(valueOf).toString());
        }
        return zzbga.zzbKV;
    }
