...
public final class zzaal extends GoogleApiClient implements com.google.android.gms.internal.zzaau.zza {
    ...
    class C08881 implements com.google.android.gms.common.internal.zzm.zza {
        final /* synthetic */ zzaal zzaAz;

        C08881(zzaal com_google_android_gms_internal_zzaal) {
    ...
    class C08892 implements ConnectionCallbacks {
        final /* synthetic */ AtomicReference zzaAA;
        final /* synthetic */ zzabl zzaAB;
        final /* synthetic */ zzaal zzaAz;

        C08892(zzaal com_google_android_gms_internal_zzaal, AtomicReference atomicReference, zzabl com_google_android_gms_internal_zzabl) {
            this.zzaAz = com_google_android_gms_internal_zzaal;
    ...
    class C08903 implements OnConnectionFailedListener {
        final /* synthetic */ zzabl zzaAB;

        C08903(zzaal com_google_android_gms_internal_zzaal, zzabl com_google_android_gms_internal_zzabl) {
            this.zzaAB = com_google_android_gms_internal_zzabl;
        }
    ...
    class C08914 implements ResultCallback<Status> {
        final /* synthetic */ zzabl zzaAB;
        final /* synthetic */ boolean zzaAC;
        final /* synthetic */ zzaal zzaAz;
        final /* synthetic */ GoogleApiClient zzaob;

        C08914(zzaal com_google_android_gms_internal_zzaal, zzabl com_google_android_gms_internal_zzabl, boolean z, GoogleApiClient googleApiClient) {
            this.zzaAz = com_google_android_gms_internal_zzaal;
            this.zzaAB = com_google_android_gms_internal_zzabl;
            this.zzaAC = z;
    ...
    private void zza(GoogleApiClient googleApiClient, zzabl com_google_android_gms_internal_zzabl, boolean z) {
        zzabx.zzaFp.zzg(googleApiClient).setResultCallback(new C08914(this, com_google_android_gms_internal_zzabl, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzaAr.containsKey(zzabx.zzahc)) {
            ...
            GoogleApiClient build = new Builder(this.mContext).addApi(zzabx.API).addConnectionCallbacks(new C08892(this, atomicReference, com_google_android_gms_internal_zzabl)).addOnConnectionFailedListener(new C08903(this, com_google_android_gms_internal_zzabl)).setHandler(this.zzaAp).build();
