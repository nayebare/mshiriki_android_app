...
public class InstanceIDListenerService extends Service {
    ...
    class C08711 extends Handler {
        final /* synthetic */ InstanceIDListenerService zzbhn;

        C08711(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C08722 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzbhn;

        C08722(InstanceIDListenerService instanceIDListenerService) {
            this.zzbhn = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzbhh = new MessengerCompat(new C08711(this, Looper.getMainLooper()));
        this.zzbhi = new C08722(this);
    }
