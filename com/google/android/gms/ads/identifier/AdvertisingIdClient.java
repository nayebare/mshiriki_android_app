...
public class AdvertisingIdClient {
    ...
    class C04791 extends Thread {
        final /* synthetic */ String zzsk;

        C04791(AdvertisingIdClient advertisingIdClient, String str) {
            this.zzsk = str;
        }
    ...
    static zzcn zza(Context context, com.google.android.gms.common.zza com_google_android_gms_common_zza) throws IOException {
        try {
            return com.google.android.gms.internal.zzcn.zza.zzf(com_google_android_gms_common_zza.zza(NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS, TimeUnit.MILLISECONDS));
        } catch (InterruptedException e) {
    ...
    private void zza(Info info, boolean z, float f, Throwable th) {
        if (Math.random() <= ((double) f)) {
            new C04791(this, zza(info, z, th).toString()).start();
        }
    }
