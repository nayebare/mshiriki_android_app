...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        class C00481 implements AnimatorUpdateListener {
            ...
            C00481(int i, int i2, int i3, int i4) {
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.addUpdateListener(new C00481(startLeft, targetLeft, startRight, targetRight));
                animator.addListener(new C00492(position));
                animator.start();
            }
        }
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public TabView(Context context) {
            ...
            setClickable(true);
            ViewCompat.setPointerIcon(this, PointerIconCompat.getSystemIcon(getContext(), LocationStatusCodes.GEOFENCE_TOO_MANY_PENDING_INTENTS));
        }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0003R.styleable.TabLayout_tabIndicatorHeight, MODE_SCROLLABLE));
        this.mTabStrip.setSelectedIndicatorColor(a.getColor(C0003R.styleable.TabLayout_tabIndicatorColor, MODE_SCROLLABLE));
        int dimensionPixelSize = a.getDimensionPixelSize(C0003R.styleable.TabLayout_tabPadding, MODE_SCROLLABLE);
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0283R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0283R.styleable.TextAppearance_android_textSize, MODE_SCROLLABLE);
            this.mTabTextColors = ta.getColorStateList(C0283R.styleable.TextAppearance_android_textColor);
            ...
            if (a.hasValue(C0003R.styleable.TabLayout_tabSelectedTextColor)) {
                this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), a.getColor(C0003R.styleable.TabLayout_tabSelectedTextColor, MODE_SCROLLABLE));
            }
            this.mRequestedTabMinWidth = a.getDimensionPixelSize(C0003R.styleable.TabLayout_tabMinWidth, INVALID_WIDTH);
            this.mRequestedTabMaxWidth = a.getDimensionPixelSize(C0003R.styleable.TabLayout_tabMaxWidth, INVALID_WIDTH);
            this.mTabBackgroundResId = a.getResourceId(C0003R.styleable.TabLayout_tabBackground, MODE_SCROLLABLE);
            this.mContentInsetStart = a.getDimensionPixelSize(C0003R.styleable.TabLayout_tabContentStart, MODE_SCROLLABLE);
            this.mMode = a.getInt(C0003R.styleable.TabLayout_tabMode, MODE_FIXED);
            this.mTabGravity = a.getInt(C0003R.styleable.TabLayout_tabGravity, MODE_SCROLLABLE);
            a.recycle();
            Resources res = getResources();
