...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C02801 extends ViewPropertyAnimatorListenerAdapter {
        C02801() {
        }
    ...
    class C02812 extends ViewPropertyAnimatorListenerAdapter {
        C02812() {
        }
    ...
    class C02823 implements ViewPropertyAnimatorUpdateListener {
        C02823() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C02801();
        this.mShowListener = new C02812();
        this.mUpdateListener = new C02823();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0283R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0283R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0283R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0283R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0283R.styleable.ActionBar, C0283R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0283R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0283R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0283R.attr.actionBarWidgetTheme, outValue, true);
