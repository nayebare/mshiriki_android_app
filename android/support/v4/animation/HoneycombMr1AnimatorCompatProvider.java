...
class HoneycombMr1AnimatorCompatProvider implements AnimatorProvider {
    ...
    static class HoneycombValueAnimatorCompat implements ValueAnimatorCompat {
        ...
        class C00851 implements AnimatorUpdateListener {
            final /* synthetic */ AnimatorUpdateListenerCompat val$animatorUpdateListener;

            C00851(AnimatorUpdateListenerCompat animatorUpdateListenerCompat) {
        ...
        public void addUpdateListener(AnimatorUpdateListenerCompat animatorUpdateListener) {
            if (this.mWrapped instanceof ValueAnimator) {
                ((ValueAnimator) this.mWrapped).addUpdateListener(new C00851(animatorUpdateListener));
            }
        }
    ...
    public ValueAnimatorCompat emptyValueAnimator() {
        return new HoneycombValueAnimatorCompat(ValueAnimator.ofFloat(new float[]{0.0f, TextTrackStyle.DEFAULT_FONT_SCALE}));
    }
