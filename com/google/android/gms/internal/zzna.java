...
public final class zzna {
    private static final SimpleDateFormat zzTg;

    static {
        zzTg = new SimpleDateFormat("yyyyMMdd", Locale.US);
    }
        ...
        try {
            ...
            if (com_google_android_gms_internal_zzmk != null) {
                ...
                if (com_google_android_gms_internal_zzmk.zzRJ > 0) {
                    ...
                    return new zzmk(com_google_android_gms_internal_zzmh, optString2, str2, list, list2, j3, jSONObject.optBoolean("mediation", false), jSONObject.optLong("mediation_config_cache_time_milliseconds", -1), list3, jSONObject.optLong("refresh_interval_milliseconds", -1), i, optString4, j, optString7, optBoolean, str3, optString9, jSONObject.optBoolean("custom_render_allowed", false), z, com_google_android_gms_internal_zzmh.zzRl, jSONObject.optBoolean("content_url_opted_out", true), jSONObject.optBoolean("prefetch", false), jSONObject.optString("gws_query_id", BuildConfig.FLAVOR), "height".equals(jSONObject.optString("fluid", BuildConfig.FLAVOR)), jSONObject.optBoolean("native_express", false), zzok.zza(jSONObject.optJSONArray("rewards")), zza(jSONObject.optJSONArray("video_start_urls"), null), zza(jSONObject.optJSONArray("video_complete_urls"), null), jSONObject.optBoolean("use_displayed_impression", false), zzmm.zzg(jSONObject.optJSONObject("auto_protection_configuration")), com_google_android_gms_internal_zzmh.zzRB, jSONObject.optString("set_cookie", BuildConfig.FLAVOR), zza(jSONObject.optJSONArray("remote_ping_urls"), null), jSONObject.optBoolean("render_in_browser", com_google_android_gms_internal_zzmh.zzKc), optString5, zzon.zzi(jSONObject.optJSONObject("safe_browsing")), optString8, jSONObject.optBoolean("content_vertical_opted_out", true));
                }
            }
            j3 = j2;
            optString9 = jSONObject.optString("active_view");
    ...
    public static JSONObject zza(Context context, zzmx com_google_android_gms_internal_zzmx) {
        ...
        if (zzpy.zzai(2)) {
            ...
            zzpe.m26v(valueOf.length() != 0 ? str.concat(valueOf) : new String(str));
        }
    ...
    private static void zza(HashMap<String, Object> hashMap, zzdy com_google_android_gms_internal_zzdy) {
        ...
        if (com_google_android_gms_internal_zzdy.versionCode >= 3 && com_google_android_gms_internal_zzdy.zzyO != null) {
            hashMap.put(PlusShare.KEY_CALL_TO_ACTION_URL, com_google_android_gms_internal_zzdy.zzyO);
        }
    ...
    public static JSONObject zzc(zzmk com_google_android_gms_internal_zzmk) throws JSONException {
        ...
        jSONObject.put("fluid", com_google_android_gms_internal_zzmk.zzzo ? "height" : BuildConfig.FLAVOR);
