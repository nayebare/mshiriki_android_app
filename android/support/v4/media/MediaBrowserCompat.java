    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallbackInternal {
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                this.mHandler.post(new C01171(cb, mediaId));
            } else if (this.mServiceBinderWrapper == null) {
                this.mHandler.post(new C01182(cb, mediaId));
            } else {
                try {
                    ...
                    this.mHandler.post(new C01193(cb, mediaId));
                }
            }
        }
        ...
        public void search(@NonNull String query, Bundle extras, @NonNull SearchCallback callback) {
            if (!isConnected()) {
                ...
                this.mHandler.post(new C01204(callback, query, extras));
            } else if (this.mServiceBinderWrapper == null) {
                Log.i(MediaBrowserCompat.TAG, "The connected service doesn't support search.");
                this.mHandler.post(new C01215(callback, query, extras));
            } else {
                try {
                    ...
                    this.mHandler.post(new C01226(callback, query, extras));
                }
            }
        }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        private class MediaServiceConnection implements ServiceConnection {
            ...
            public void onServiceConnected(ComponentName name, IBinder binder) {
                postOrRun(new C01281(name, binder));
            }

            public void onServiceDisconnected(ComponentName name) {
                postOrRun(new C01292(name));
            }
        ...
        public void connect() {
            if (this.mState != 0) {
                ...
                if (!bound) {
                    this.mHandler.post(new C01231(thisConnection));
                }
                if (MediaBrowserCompat.DEBUG) {
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                Log.i(MediaBrowserCompat.TAG, "Not connected, unable to retrieve the MediaItem.");
                this.mHandler.post(new C01242(cb, mediaId));
            } else {
                try {
                    this.mServiceBinderWrapper.getMediaItem(mediaId, new ItemReceiver(mediaId, cb, this.mHandler), this.mCallbacksMessenger);
                } catch (RemoteException e) {
                    Log.i(MediaBrowserCompat.TAG, "Remote error getting media item.");
                    this.mHandler.post(new C01253(cb, mediaId));
                }
            }
        }
        ...
        public void search(@NonNull String query, Bundle extras, @NonNull SearchCallback callback) {
            if (isConnected()) {
                try {
                    ...
                    Log.i(MediaBrowserCompat.TAG, "Remote error searching items with query: " + query, e);
                    this.mHandler.post(new C01275(callback, query, extras));
                    return;
                }
            }
            Log.i(MediaBrowserCompat.TAG, "Not connected, unable to search.");
            this.mHandler.post(new C01264(callback, query, extras));
        }
