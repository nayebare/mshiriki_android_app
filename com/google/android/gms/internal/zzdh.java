...
public class zzdh {
    ...
    static String zza(String[] strArr, int i, int i2) {
        if (strArr.length < i + i2) {
            zzpy.m25e("Unable to construct shingle");
    ...
    static void zza(int i, long j, String str, int i2, PriorityQueue<zza> priorityQueue) {
        zza com_google_android_gms_internal_zzdh_zza = new zza(j, str, i2);
        if ((priorityQueue.size() != i || (((zza) priorityQueue.peek()).zzyk <= com_google_android_gms_internal_zzdh_zza.zzyk && ((zza) priorityQueue.peek()).value <= com_google_android_gms_internal_zzdh_zza.value)) && !priorityQueue.contains(com_google_android_gms_internal_zzdh_zza)) {
            priorityQueue.add(com_google_android_gms_internal_zzdh_zza);
