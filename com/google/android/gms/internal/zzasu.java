...
class zzasu extends zzats {
    ...
    public void zza(String str, long j, long j2, zzb com_google_android_gms_internal_zzasu_zzb) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            str2 = j2 != -1 ? "rowid <= ? and " : BuildConfig.FLAVOR;
        ...
        str2 = j2 != -1 ? " and rowid <= ?" : BuildConfig.FLAVOR;
    ...
    public boolean zza(zzaud com_google_android_gms_internal_zzaud) {
        ...
        zza(contentValues, "value", com_google_android_gms_internal_zzaud.zzYe);
        try {
    ...
    public List<zzaud> zzfx(String str) {
        ...
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"name", "set_timestamp", "value"}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(zzJv().zzKf()));
            try {
                if (query.moveToFirst()) {
                    do {
