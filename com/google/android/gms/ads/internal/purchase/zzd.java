...
public class zzd extends zza {
    ...
    public void recordPlayBillingResolution(int i) {
        ...
        zzip.put(Games.EXTRA_STATUS, String.valueOf(zzN(i)));
    ...
    public void recordResolution(int i) {
        ...
        Map zzip = zzip();
        zzip.put(Games.EXTRA_STATUS, String.valueOf(i));
        zzip.put("sku", this.zzOX);
        List linkedList = new LinkedList();
        Iterator it = this.zzOY.iterator();
        while (it.hasNext()) {
    ...
    void zziq() {
        try {
            this.mContext.getClassLoader().loadClass("com.google.ads.conversiontracking.IAPConversionReporter").getDeclaredMethod("reportWithProductId", new Class[]{Context.class, String.class, String.class, Boolean.TYPE}).invoke(null, new Object[]{this.mContext, this.zzOX, BuildConfig.FLAVOR, Boolean.valueOf(true)});
