...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mScaleUpFactor = (((float) activeLabelSize) * TextTrackStyle.DEFAULT_FONT_SCALE) / ((float) inactiveLabelSize);
        this.mScaleDownFactor = (((float) inactiveLabelSize) * TextTrackStyle.DEFAULT_FONT_SCALE) / ((float) activeLabelSize);
    ...
    public void setChecked(boolean checked) {
        ...
        if (this.mShiftingMode) {
            if (checked) {
                ...
                ViewCompat.setScaleX(this.mLargeLabel, TextTrackStyle.DEFAULT_FONT_SCALE);
                ViewCompat.setScaleY(this.mLargeLabel, TextTrackStyle.DEFAULT_FONT_SCALE);
            } else {
                iconParams = (LayoutParams) this.mIcon.getLayoutParams();
            ...
            ViewCompat.setScaleX(this.mSmallLabel, TextTrackStyle.DEFAULT_FONT_SCALE);
            ViewCompat.setScaleY(this.mSmallLabel, TextTrackStyle.DEFAULT_FONT_SCALE);
        }
        refreshDrawableState();
    }
