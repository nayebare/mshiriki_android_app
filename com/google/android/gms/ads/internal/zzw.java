...
public final class zzw implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public static class zza extends ViewSwitcher {
        ...
        public void zzdo() {
            zzpe.m26v("Disable position monitoring on adFrame.");
            if (this.zzvP != null) {
                this.zzvP.zzkF();
            }
        }
        ...
        public void zzdt() {
            zzpe.m26v("Enable debug gesture detector on adFrame.");
            this.zzvQ = true;
        }

        public void zzdu() {
            zzpe.m26v("Disable debug gesture detector on adFrame.");
            this.zzvQ = false;
        }
    }
    ...
    public String zzdq() {
        return (this.zzvL && this.zzvM) ? BuildConfig.FLAVOR : this.zzvL ? this.zzvN ? "top-scrollable" : "top-locked" : this.zzvM ? this.zzvN ? "bottom-scrollable" : "bottom-locked" : BuildConfig.FLAVOR;
    }
