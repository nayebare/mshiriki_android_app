...
public abstract class GcmListenerService extends Service {
    ...
    class C08591 implements Runnable {
        ...
        C08591(GcmListenerService gcmListenerService, Intent intent) {
    ...
    class C08602 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzbfK;

        C08602(GcmListenerService gcmListenerService, Intent intent) {
            this.zzbfK = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    private void zzl(Intent intent) {
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C08591(this, intent));
        } else {
            new C08602(this, intent).execute(new Void[0]);
        }
    }
