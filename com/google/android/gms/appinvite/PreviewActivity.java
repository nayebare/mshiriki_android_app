...
public class PreviewActivity extends Activity {
    ...
    /* renamed from: com.google.android.gms.appinvite.PreviewActivity.1 */
    class C05421 implements OnClickListener {
        final /* synthetic */ PreviewActivity zzahh;

        C05421(PreviewActivity previewActivity) {
            this.zzahh = previewActivity;
        }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (getCallingActivity() == null || !GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE.equals(getCallingActivity().getPackageName())) {
            finish();
            return;
        }
        try {
            Context createPackageContext = createPackageContext(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE, 0);
            ...
            if (!(tabHost == null || tabWidget == null || parcelableArrayList == null)) {
                ...
                while (it.hasNext()) {
                    ...
                    TabSpec newTabSpec = tabHost.newTabSpec(extras.getString(KEY_TAB_TAG));
                    newTabSpec.setContent(extras.getInt(KEY_TAB_CONTENT_ID));
