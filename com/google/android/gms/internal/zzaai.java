...
public class zzaai implements zzaam {
    ...
    class C08821 extends zza {
        final /* synthetic */ zzaai zzazM;

        C08821(zzaai com_google_android_gms_internal_zzaai, zzaam com_google_android_gms_internal_zzaam) {
    ...
    class C08832 extends zza {
        final /* synthetic */ zzaai zzazM;

        C08832(zzaai com_google_android_gms_internal_zzaai, zzaam com_google_android_gms_internal_zzaam) {
            this.zzazM = com_google_android_gms_internal_zzaai;
            super(com_google_android_gms_internal_zzaam);
        }
    ...
    public void connect() {
        if (this.zzazL) {
            this.zzazL = false;
            this.zzazK.zza(new C08832(this, this));
        }
    }
    ...
    public <A extends zzb, T extends zza<? extends Result, A>> T zzb(T t) {
        try {
            ...
            this.zzazK.zza(new C08821(this, this));
        }
        return t;
    }
