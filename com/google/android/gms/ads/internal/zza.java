...
public abstract class zza extends com.google.android.gms.internal.zzep.zza implements zzq, zzdt, zzht, com.google.android.gms.internal.zzln.zza, com.google.android.gms.internal.zzmc.zza, zzpa {
    ...
    class C04981 extends TimerTask {
        final /* synthetic */ CountDownLatch zzsA;
        final /* synthetic */ Timer zzsB;
        final /* synthetic */ zza zzsC;

        C04981(zza com_google_android_gms_ads_internal_zza, CountDownLatch countDownLatch, Timer timer) {
            this.zzsC = com_google_android_gms_ads_internal_zza;
            this.zzsA = countDownLatch;
            this.zzsB = timer;
        }

        public void run() {
            if (((long) ((Integer) zzfx.zzEh.get()).intValue()) != this.zzsA.getCount()) {
                zzpy.zzbc("Stopping method tracing");
                Debug.stopMethodTracing();
                if (this.zzsA.getCount() == 0) {
                    this.zzsB.cancel();
                    return;
                }
            }
    ...
    zza(zzw com_google_android_gms_ads_internal_zzw, @Nullable zzs com_google_android_gms_ads_internal_zzs, zzd com_google_android_gms_ads_internal_zzd) {
        this.zzsu = false;
    ...
    private TimerTask zza(Timer timer, CountDownLatch countDownLatch) {
        return new C04981(this, countDownLatch, timer);
    }
    ...
    public void zza(@Nullable zzfn com_google_android_gms_internal_zzfn) {
    ...
    protected void zza(@Nullable zzok com_google_android_gms_internal_zzok) {
    ...
    protected abstract boolean zza(@Nullable zzov com_google_android_gms_internal_zzov, zzov com_google_android_gms_internal_zzov2);
    ...
    protected void zzc(@Nullable zzov com_google_android_gms_internal_zzov) {
