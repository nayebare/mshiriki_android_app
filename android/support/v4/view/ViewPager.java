...
public class ViewPager extends ViewGroup {
    ...
    static class C02011 implements Comparator<ItemInfo> {
        C02011() {
        }
    ...
    static class C02022 implements Interpolator {
        C02022() {
        }
    ...
    class C02044 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02051 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02051() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02051());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C02011();
        sInterpolator = new C02022();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C02033();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02044());
    }
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C0308R.styleable.AppCompatTheme_spinnerStyle;
                ...
                switch (action & MotionEventCompat.ACTION_MASK) {
                    ...
                    case SCROLL_STATE_DRAGGING /*1*/:
                        if (this.mIsBeingDragged) {
                            ...
                            velocityTracker.computeCurrentVelocity(CardNetwork.OTHER, (float) this.mMaximumVelocity);
