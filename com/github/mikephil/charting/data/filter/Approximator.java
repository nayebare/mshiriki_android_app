...
public class Approximator {
    ...
    static /* synthetic */ class C04681 {
        static final /* synthetic */ int[] f12xc71afc41;

        static {
            f12xc71afc41 = new int[ApproximatorType.values().length];
            try {
                f12xc71afc41[ApproximatorType.DOUGLAS_PEUCKER.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f12xc71afc41[ApproximatorType.NONE.ordinal()] = 2;
    ...
    public Approximator() {
        ...
        this.mScaleRatio = TextTrackStyle.DEFAULT_FONT_SCALE;
        this.mDeltaRatio = TextTrackStyle.DEFAULT_FONT_SCALE;
    ...
    public List<Entry> filter(List<Entry> points, double tolerance) {
        ...
        switch (C04681.f12xc71afc41[this.mType.ordinal()]) {
