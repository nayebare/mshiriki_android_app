...
public class LegendRenderer extends Renderer {
    ...
    static /* synthetic */ class C04701 {
        static final /* synthetic */ int[] f17xfbec3b85;
        static final /* synthetic */ int[] f18x7d277f6a;

        static {
            f17xfbec3b85 = new int[LegendForm.values().length];
            try {
                f17xfbec3b85[LegendForm.CIRCLE.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f17xfbec3b85[LegendForm.SQUARE.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f17xfbec3b85[LegendForm.LINE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            f18x7d277f6a = new int[LegendPosition.values().length];
            try {
                f18x7d277f6a[LegendPosition.BELOW_CHART_LEFT.ordinal()] = 1;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f18x7d277f6a[LegendPosition.BELOW_CHART_RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f18x7d277f6a[LegendPosition.BELOW_CHART_CENTER.ordinal()] = 3;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f18x7d277f6a[LegendPosition.ABOVE_CHART_LEFT.ordinal()] = 4;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f18x7d277f6a[LegendPosition.ABOVE_CHART_RIGHT.ordinal()] = 5;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f18x7d277f6a[LegendPosition.ABOVE_CHART_CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f18x7d277f6a[LegendPosition.PIECHART_CENTER.ordinal()] = 7;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f18x7d277f6a[LegendPosition.RIGHT_OF_CHART.ordinal()] = 8;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f18x7d277f6a[LegendPosition.RIGHT_OF_CHART_CENTER.ordinal()] = 9;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f18x7d277f6a[LegendPosition.RIGHT_OF_CHART_INSIDE.ordinal()] = 10;
            } catch (NoSuchFieldError e13) {
            }
            try {
                f18x7d277f6a[LegendPosition.LEFT_OF_CHART.ordinal()] = 11;
            } catch (NoSuchFieldError e14) {
            }
            try {
                f18x7d277f6a[LegendPosition.LEFT_OF_CHART_CENTER.ordinal()] = 12;
            } catch (NoSuchFieldError e15) {
            }
            try {
                f18x7d277f6a[LegendPosition.LEFT_OF_CHART_INSIDE.ordinal()] = 13;
    ...
    public void renderLegend(Canvas c) {
        if (this.mLegend.isEnabled()) {
            ...
            float formYOffset = labelLineHeight - (((float) Utils.calcTextHeight(this.mLegendLabelPaint, "ABC")) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
            ...
            float posY;
            int i;
            switch (C04701.f18x7d277f6a[legendPosition.ordinal()]) {
                ...
                case BuyButtonText.LOGO_ONLY /*6*/:
                    ...
                    if (legendPosition == LegendPosition.BELOW_CHART_LEFT || legendPosition == LegendPosition.ABOVE_CHART_LEFT) {
                        ...
                        originPosX = this.mViewPortHandler.contentLeft() + (contentWidth / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
                    }
                    ...
                    while (i < count) {
                        ...
                        if (posX == originPosX && legendPosition == LegendPosition.BELOW_CHART_CENTER && lineIndex < calculatedLineSizes.length) {
                            posX += (direction == LegendDirection.RIGHT_TO_LEFT ? calculatedLineSizes[lineIndex].width : -calculatedLineSizes[lineIndex].width) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
                            lineIndex++;
                        }
                ...
                case HTTP.CR /*13*/:
                    ...
                    if (legendPosition == LegendPosition.PIECHART_CENTER) {
                        posX = (this.mViewPortHandler.getChartWidth() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) + (direction == LegendDirection.LEFT_TO_RIGHT ? (-this.mLegend.mTextWidthMax) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT : this.mLegend.mTextWidthMax / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
                        posY = ((this.mViewPortHandler.getChartHeight() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - (this.mLegend.mNeededHeight / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) + this.mLegend.getYOffset();
                    } else {
                        ...
                        if (legendPosition == LegendPosition.RIGHT_OF_CHART || legendPosition == LegendPosition.LEFT_OF_CHART) {
                            ...
                            posY = (this.mViewPortHandler.getChartHeight() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) - (this.mLegend.mNeededHeight / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
                        } else {
                            posY = this.mViewPortHandler.contentTop() + yoffset;
                        }
                    }
    ...
    protected void drawForm(Canvas c, float x, float y, int index, Legend legend) {
        if (legend.getColors()[index] != -2) {
            ...
            float half = formsize / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
            switch (C04701.f17xfbec3b85[legend.getForm().ordinal()]) {
                case MessageApi.FILTER_PREFIX /*1*/:
