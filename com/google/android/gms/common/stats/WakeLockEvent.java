...
public final class WakeLockEvent extends StatsEvent {
    ...
    public String zzyf() {
        ...
        String join = zzyk() == null ? BuildConfig.FLAVOR : TextUtils.join(",", zzyk());
        String valueOf5 = String.valueOf("\t");
        int zzyn = zzyn();
        String valueOf6 = String.valueOf("\t");
        String zzyh = zzyh() == null ? BuildConfig.FLAVOR : zzyh();
        String valueOf7 = String.valueOf("\t");
        String zzyo = zzyo() == null ? BuildConfig.FLAVOR : zzyo();
        String valueOf8 = String.valueOf("\t");
        float zzyp = zzyp();
        String valueOf9 = String.valueOf("\t");
        String zzyi = zzyi() == null ? BuildConfig.FLAVOR : zzyi();
