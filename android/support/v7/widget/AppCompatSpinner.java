...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C03381 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C03381(View src, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C03391 implements OnItemClickListener {
            ...
            C03391(AppCompatSpinner appCompatSpinner) {
        ...
        class C03402 implements OnGlobalLayoutListener {
            C03402() {
            }
        ...
        class C03413 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C03413(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C03391(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C03402();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C03413(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0283R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0283R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0283R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (popupTheme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, popupTheme);
        } else {
            int popupThemeResId = a.getResourceId(C0283R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0283R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
                this.mDropDownWidth = pa.getLayoutDimension(C0283R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C0283R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C0283R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new C03381(this, popup);
            }
        }
        CharSequence[] entries = a.getTextArray(C0283R.styleable.Spinner_android_entries);
        if (entries != null) {
            SpinnerAdapter adapter = new ArrayAdapter(context, 17367048, entries);
            adapter.setDropDownViewResource(C0283R.layout.support_simple_spinner_dropdown_item);
            setAdapter(adapter);
        }
        a.recycle();
        this.mPopupSet = true;
