...
public class zzgv implements zzgu {
    ...
    @Nullable
    private String zzGv;
    private WeakReference<View> zzGw;
    private final Object zzrN;
    @Nullable
    private final zzqa zztr;

    public zzgv(Context context, zzr com_google_android_gms_ads_internal_zzr, @Nullable zzlt com_google_android_gms_internal_zzlt, zzav com_google_android_gms_internal_zzav, @Nullable JSONObject jSONObject, @Nullable zza com_google_android_gms_internal_zzgu_zza, @Nullable zzqa com_google_android_gms_internal_zzqa, @Nullable String str) {
    ...
    public void zza(View view, String str, @Nullable JSONObject jSONObject, Map<String, WeakReference<View>> map, View view2) {
        ...
        try {
            ...
            this.zzGp.zza(new 1(this, jSONObject3));
        } catch (Throwable e2) {
    ...
    public void zzb(View view, Map<String, WeakReference<View>> map) {
        ...
        try {
            ...
            this.zzGp.zza(new 2(this, jSONObject));
        } catch (Throwable e) {
