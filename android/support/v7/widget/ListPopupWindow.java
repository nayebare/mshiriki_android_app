...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C03571 extends ForwardingListener {
        C03571(View src) {
            super(src);
        }
    ...
    class C03593 implements OnItemSelectedListener {
        C03593() {
        }
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0283R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0283R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        this.mDropDownWindowLayoutType = LocationStatusCodes.GEOFENCE_TOO_MANY_PENDING_INTENTS;
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0283R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0283R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0283R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C03582();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C03593());
