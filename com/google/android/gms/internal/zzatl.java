...
class zzatl extends zzats {
    ...
    static {
        zzbse = new Pair(BuildConfig.FLAVOR, Long.valueOf(0));
    }
    ...
    zzatl(zzatp com_google_android_gms_internal_zzatp) {
        ...
        this.zzbsp = new zzb(this, "time_before_start", NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS);
