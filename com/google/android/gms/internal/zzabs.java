...
public abstract class zzabs<T> {
    ...
    class C09011 extends zzabs<Boolean> {
        C09011(String str, Boolean bool) {
            super(str, bool);
        }
    ...
    class C09022 extends zzabs<Long> {
        C09022(String str, Long l) {
            super(str, l);
        }
    ...
    class C09033 extends zzabs<Integer> {
        C09033(String str, Integer num) {
            super(str, num);
        }
    ...
    class C09044 extends zzabs<Float> {
        C09044(String str, Float f) {
            super(str, f);
        }
    ...
    class C09055 extends zzabs<String> {
        C09055(String str, String str2) {
            super(str, str2);
        }
