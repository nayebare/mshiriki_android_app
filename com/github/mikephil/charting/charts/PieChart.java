...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public PieChart(Context context) {
        ...
        this.mCenterTextRadiusPercent = TextTrackStyle.DEFAULT_FONT_SCALE;
    }
    ...
    public void calculateOffsets() {
        ...
        if (!this.mDataNotSet) {
            float radius = getDiameter() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
    ...
    protected float[] getMarkerPosition(Entry e, Highlight highlight) {
        ...
        if (isDrawHoleEnabled()) {
            off = (r - ((r / 100.0f) * getHoleRadius())) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
        }
        r -= off;
        float rotationAngle = getRotationAngle();
        int i = e.getXIndex();
        float offset = this.mDrawAngles[i] / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
    ...
    protected float getRequiredLegendOffset() {
        return this.mLegendRenderer.getLabelPaint().getTextSize() * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
    }
    ...
    public float getRadius() {
        ...
        return Math.min(this.mCircleBox.width() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT, this.mCircleBox.height() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    }
