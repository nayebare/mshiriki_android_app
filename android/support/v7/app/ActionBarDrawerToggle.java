...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    ActionBarDrawerToggle(Activity activity, Toolbar toolbar, DrawerLayout drawerLayout, DrawerArrowDrawable slider, @StringRes int openDrawerContentDescRes, @StringRes int closeDrawerContentDescRes) {
        ...
        if (toolbar != null) {
            ...
            toolbar.setNavigationOnClickListener(new C02411());
    ...
    public void syncState() {
        if (this.mDrawerLayout.isDrawerOpen((int) MediaRouterJellybean.ALL_ROUTE_TYPES)) {
            setPosition(TextTrackStyle.DEFAULT_FONT_SCALE);
        } else {
            setPosition(0.0f);
        }
    ...
    void toggle() {
        int drawerLockMode = this.mDrawerLayout.getDrawerLockMode((int) MediaRouterJellybean.ALL_ROUTE_TYPES);
        if (this.mDrawerLayout.isDrawerVisible((int) MediaRouterJellybean.ALL_ROUTE_TYPES) && drawerLockMode != 2) {
    ...
    public void onDrawerSlide(View drawerView, float slideOffset) {
        if (this.mDrawerSlideAnimationEnabled) {
            setPosition(Math.min(TextTrackStyle.DEFAULT_FONT_SCALE, Math.max(0.0f, slideOffset)));
        } else {
            setPosition(0.0f);
        }
    }
