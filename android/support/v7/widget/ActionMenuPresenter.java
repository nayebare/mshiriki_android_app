...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu, View anchorView) {
            super(context, subMenu, anchorView, false, C0283R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuChildView {
        ...
        class C03311 extends ForwardingListener {
            final /* synthetic */ ActionMenuPresenter val$this$0;

            C03311(View src, ActionMenuPresenter actionMenuPresenter) {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0283R.attr.actionOverflowButtonStyle);
            this.mTempPts = new float[2];
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new C03311(this, ActionMenuPresenter.this));
        }
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
            super(context, menu, anchorView, overflowOnly, C0283R.attr.actionOverflowMenuStyle);
    ...
    private static class SavedState implements Parcelable {
        ...
        static class C03321 implements Creator<SavedState> {
            C03321() {
            }
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0283R.layout.abc_action_menu_layout, C0283R.layout.abc_action_menu_item_layout);
