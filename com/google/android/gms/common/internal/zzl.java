...
public abstract class zzl<T extends IInterface> extends zzf<T> implements zze, zza {
    ...
    class C06391 implements zzb {
        final /* synthetic */ ConnectionCallbacks zzaEu;

        C06391(ConnectionCallbacks connectionCallbacks) {
    ...
    class C06402 implements zzc {
        final /* synthetic */ OnConnectionFailedListener zzaEv;

        C06402(OnConnectionFailedListener onConnectionFailedListener) {
    ...
    private static zzb zza(ConnectionCallbacks connectionCallbacks) {
        return connectionCallbacks == null ? null : new C06391(connectionCallbacks);
    }

    @Nullable
    private static zzc zza(OnConnectionFailedListener onConnectionFailedListener) {
        return onConnectionFailedListener == null ? null : new C06402(onConnectionFailedListener);
    }
