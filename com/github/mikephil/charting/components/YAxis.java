...
public class YAxis extends AxisBase {
    ...
    public float getRequiredWidthSpace(Paint p) {
        ...
        return ((float) Utils.calcTextWidth(p, getLongestLabel())) + (getXOffset() * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    }

    public float getRequiredHeightSpace(Paint p) {
        p.setTextSize(this.mTextSize);
        return (((float) Utils.calcTextHeight(p, getLongestLabel())) + (Utils.convertDpToPixel(2.5f) * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) + getYOffset();
    }
