...
public class SwitchCompat extends CompoundButton {
    ...
    class C03901 implements AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            if (SwitchCompat.this.mPositionAnimator == animation) {
                SwitchCompat.this.setThumbPosition(this.val$newCheckedState ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f);
    ...
    public SwitchCompat(Context context, AttributeSet attrs) {
        this(context, attrs, C0283R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0283R.styleable.SwitchCompat, defStyleAttr, 0);
        this.mThumbDrawable = a.getDrawable(C0283R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = a.getDrawable(C0283R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = a.getText(C0283R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = a.getText(C0283R.styleable.SwitchCompat_android_textOff);
        this.mShowText = a.getBoolean(C0283R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = a.getDimensionPixelSize(C0283R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = a.getDimensionPixelSize(C0283R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = a.getDimensionPixelSize(C0283R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = a.getBoolean(C0283R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList thumbTintList = a.getColorStateList(C0283R.styleable.SwitchCompat_thumbTint);
        if (thumbTintList != null) {
            this.mThumbTintList = thumbTintList;
            this.mHasThumbTint = true;
        }
        Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(C0283R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList trackTintList = a.getColorStateList(C0283R.styleable.SwitchCompat_trackTint);
        if (trackTintList != null) {
            this.mTrackTintList = trackTintList;
            this.mHasTrackTint = true;
        }
        Mode trackTintMode = DrawableUtils.parseTintMode(a.getInt(C0283R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int appearance = a.getResourceId(C0283R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (appearance != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        TintTypedArray appearance = TintTypedArray.obtainStyledAttributes(context, resid, C0283R.styleable.TextAppearance);
        ColorStateList colors = appearance.getColorStateList(C0283R.styleable.TextAppearance_android_textColor);
        if (colors != null) {
            this.mTextColors = colors;
        } else {
            this.mTextColors = getTextColors();
        }
        int ts = appearance.getDimensionPixelSize(C0283R.styleable.TextAppearance_android_textSize, 0);
        if (!(ts == 0 || ((float) ts) == this.mTextPaint.getTextSize())) {
            this.mTextPaint.setTextSize((float) ts);
            requestLayout();
        }
        setSwitchTypefaceByIndex(appearance.getInt(C0283R.styleable.TextAppearance_android_typeface, -1), appearance.getInt(C0283R.styleable.TextAppearance_android_textStyle, -1));
        if (appearance.getBoolean(C0283R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    private Layout makeLayout(CharSequence text) {
        ...
        return new StaticLayout(transformed, this.mTextPaint, transformed != null ? (int) Math.ceil((double) Layout.getDesiredWidth(transformed, this.mTextPaint)) : 0, Alignment.ALIGN_NORMAL, TextTrackStyle.DEFAULT_FONT_SCALE, 0.0f, true);
    }
                ...
                switch (this.mTouchMode) {
                    ...
                    case TOUCH_MODE_DRAGGING /*2*/:
                        ...
                        if (thumbScrollRange != 0) {
                            ...
                            dPos = thumbScrollOffset > 0.0f ? TextTrackStyle.DEFAULT_FONT_SCALE : PlayerStats.UNSET_VALUE;
                        }
    ...
    private void stopDrag(MotionEvent ev) {
        ...
        if (commitChange) {
            this.mVelocityTracker.computeCurrentVelocity(CardNetwork.OTHER);
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        ...
        this.mPositionAnimator = new ThumbAnimation(this.mThumbPosition, newCheckedState ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f);
        this.mPositionAnimator.setDuration(250);
        this.mPositionAnimator.setAnimationListener(new C03901(newCheckedState));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        switch (getGravity() & C0308R.styleable.AppCompatTheme_spinnerStyle) {
    ...
    public void jumpDrawablesToCurrentState() {
        if (VERSION.SDK_INT >= 11) {
            ...
            cancelPositionAnimator();
            setThumbPosition(isChecked() ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f);
        }
    }
