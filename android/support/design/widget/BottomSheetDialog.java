...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00282 extends AccessibilityDelegateCompat {
        C00282() {
        }
    ...
    class C00293 extends BottomSheetCallback {
        C00293() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C00293();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        coordinator.findViewById(C0003R.id.touch_outside).setOnClickListener(new C00271());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C00282());
        return coordinator;
    }
