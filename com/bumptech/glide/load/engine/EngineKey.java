...
class EngineKey implements Key {
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) throws UnsupportedEncodingException {
        ...
        messageDigest.update((this.cacheDecoder != null ? this.cacheDecoder.getId() : EMPTY_LOG_STRING).getBytes(HTTP.UTF_8));
        messageDigest.update((this.decoder != null ? this.decoder.getId() : EMPTY_LOG_STRING).getBytes(HTTP.UTF_8));
        messageDigest.update((this.transformation != null ? this.transformation.getId() : EMPTY_LOG_STRING).getBytes(HTTP.UTF_8));
        messageDigest.update((this.encoder != null ? this.encoder.getId() : EMPTY_LOG_STRING).getBytes(HTTP.UTF_8));
        messageDigest.update((this.sourceEncoder != null ? this.sourceEncoder.getId() : EMPTY_LOG_STRING).getBytes(HTTP.UTF_8));
    }
}
