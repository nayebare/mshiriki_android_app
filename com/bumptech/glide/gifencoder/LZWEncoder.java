...
class LZWEncoder {
    ...
    LZWEncoder(int width, int height, byte[] pixels, int color_depth) {
        ...
        this.cur_accum = 0;
        this.cur_bits = 0;
        this.masks = new int[]{0, 1, 3, 7, 15, 31, 63, TransportMediator.KEYCODE_MEDIA_PAUSE, MotionEventCompat.ACTION_MASK, 511, 1023, 2047, 4095, 8191, 16383, 32767, GameRequest.TYPE_ALL};
        this.accum = new byte[FileUploadPreferences.BATTERY_USAGE_UNRESTRICTED];
        this.imgW = width;
        this.imgH = height;
        this.pixAry = pixels;
