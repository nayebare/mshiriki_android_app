...
public class ListPreloader<T> implements OnScrollListener {
    ...
    class C04221 implements PreloadModelProvider<T> {
        C04221() {
        }
    ...
    class C04232 implements PreloadSizeProvider<T> {
        C04232() {
        }
    ...
    public ListPreloader(int maxPreload) {
        ...
        this.preloadModelProvider = new C04221();
        this.preloadDimensionProvider = new C04232();
