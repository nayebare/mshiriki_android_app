...
public class zzl extends FrameLayout implements zzi {
    ...
    class C04921 implements Runnable {
        ...
        C04921(zzl com_google_android_gms_ads_internal_overlay_zzl) {
            this.zzNz = com_google_android_gms_ads_internal_overlay_zzl;
        }
    ...
    class C04932 implements Runnable {
        ...
        C04932(zzl com_google_android_gms_ads_internal_overlay_zzl) {
            this.zzNz = com_google_android_gms_ads_internal_overlay_zzl;
        }
    ...
    private void zzhI() {
        if (this.zzNw != null) {
            ...
            if (zzpe.zzkh()) {
                zzpe.m26v("Spinner frame grab took " + elapsedRealtime + "ms");
            }
    ...
    private void zzhM() {
        if (this.zzGt.zzkR() != null && !this.zzNr) {
            this.zzNs = (this.zzGt.zzkR().getWindow().getAttributes().flags & Cast.MAX_NAMESPACE_LENGTH) != 0;
            if (!this.zzNs) {
                this.zzGt.zzkR().getWindow().addFlags(Cast.MAX_NAMESPACE_LENGTH);
                this.zzNr = true;
            }
        }
    }
    ...
    private void zzhN() {
        if (this.zzGt.zzkR() != null && this.zzNr && !this.zzNs) {
            this.zzGt.zzkR().getWindow().clearFlags(Cast.MAX_NAMESPACE_LENGTH);
            this.zzNr = false;
        }
    }
    ...
    public void zzhC() {
        zzhJ();
        this.zzNv = this.zzNu;
        zzpi.zzWR.post(new C04932(this));
    }
    ...
    public void zzhy() {
        zzpi.zzWR.post(new C04921(this));
    }
