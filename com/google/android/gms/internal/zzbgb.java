...
public final class zzbgb extends zzbfw<List<zzbfw<?>>> {
    ...
    /* renamed from: com.google.android.gms.internal.zzbgb.1 */
    class C11561 implements Iterator<zzbfw<?>> {
        private int zzbKZ;
        final /* synthetic */ zzbgb zzbLa;

        C11561(zzbgb com_google_android_gms_internal_zzbgb) {
            this.zzbLa = com_google_android_gms_internal_zzbgb;
            this.zzbKZ = 0;
        }
    ...
    /* renamed from: com.google.android.gms.internal.zzbgb.2 */
    class C11572 implements Iterator<zzbfw<?>> {
        final /* synthetic */ Iterator zzbLb;
        final /* synthetic */ Iterator zzbLc;

        C11572(zzbgb com_google_android_gms_internal_zzbgb, Iterator it, Iterator it2) {
            this.zzbLb = it;
            this.zzbLc = it2;
        }

        public boolean hasNext() {
            return this.zzbLb.hasNext() || this.zzbLc.hasNext();
        }
        ...
        public zzbfw<?> zzRH() {
            return this.zzbLb.hasNext() ? (zzbfw) this.zzbLb.next() : (zzbfw) this.zzbLc.next();
        }
    }
    ...
    public Iterator<zzbfw<?>> zzRE() {
        return new C11572(this, new C11561(this), super.zzRG());
    }
