...
public final class SearchViewCompat {
    ...
    static class SearchViewCompatHoneycombImpl extends SearchViewCompatStubImpl {
        ...
        class C02261 implements OnQueryTextListenerCompatBridge {
            final /* synthetic */ OnQueryTextListener val$listener;

            C02261(OnQueryTextListener onQueryTextListener) {
        ...
        class C02272 implements OnCloseListenerCompatBridge {
            final /* synthetic */ OnCloseListener val$listener;

            C02272(OnCloseListener onCloseListener) {
        ...
        public Object newOnQueryTextListener(OnQueryTextListener listener) {
            return SearchViewCompatHoneycomb.newOnQueryTextListener(new C02261(listener));
        }
        ...
        public Object newOnCloseListener(OnCloseListener listener) {
            return SearchViewCompatHoneycomb.newOnCloseListener(new C02272(listener));
        }
