...
public class AsyncListUtil<T> {
    ...
    class C03111 implements MainThreadCallback<T> {
        C03111() {
        }
    ...
    class C03122 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C03111();
        this.mBackgroundCallback = new C03122();
        this.mTClass = klass;
