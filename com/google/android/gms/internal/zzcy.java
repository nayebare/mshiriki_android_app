...
public class zzcy {
    ...
    private ArrayList<String> zzxj;
    private ArrayList<String> zzxk;
    private ArrayList<zzdc> zzxl;
    private int zzxm;
    private int zzxn;
    private int zzxo;
    private int zzxp;
    ...
    public zzcy(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        this.zzxj = new ArrayList();
        this.zzxk = new ArrayList();
        this.zzxl = new ArrayList();
        this.zzxm = 0;
        this.zzxn = 0;
        this.zzxo = 0;
        this.zzxq = BuildConfig.FLAVOR;
        this.zzxr = BuildConfig.FLAVOR;
        this.zzxs = BuildConfig.FLAVOR;
        this.zzxe = i;
        this.zzxf = i2;
        this.zzxg = i3;
