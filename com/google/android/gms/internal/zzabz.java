...
public final class zzabz implements zzaby {
    ...
    class C09081 extends zza {
        C09081(zzabz com_google_android_gms_internal_zzabz, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzg(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C09081(this, googleApiClient));
    }
}
