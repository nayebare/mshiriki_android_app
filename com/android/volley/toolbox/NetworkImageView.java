...
public class NetworkImageView extends ImageView {
    ...
    class C04181 implements ImageListener {
        ...
        class C04171 implements Runnable {
            ...
            C04171(ImageContainer imageContainer) {
                this.val$response = imageContainer;
            }

            public void run() {
                C04181.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new C04171(response));
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new C04181(isInLayoutPass), maxWidth, maxHeight, scaleType);
        }
    }
