...
class MediaRouteExpandCollapseButton extends ImageButton {
    ...
    public MediaRouteExpandCollapseButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mExpandAnimationDrawable = (AnimationDrawable) ContextCompat.getDrawable(context, C0308R.drawable.ic_expand);
        this.mCollapseAnimationDrawable = (AnimationDrawable) ContextCompat.getDrawable(context, C0308R.drawable.ic_collapse);
        ...
        this.mExpandGroupDescription = context.getString(C0308R.string.mr_controller_expand_group);
        this.mCollapseGroupDescription = context.getString(C0308R.string.mr_controller_collapse_group);
        setImageDrawable(this.mExpandAnimationDrawable.getFrame(0));
        setContentDescription(this.mExpandGroupDescription);
        super.setOnClickListener(new C02761());
    }
