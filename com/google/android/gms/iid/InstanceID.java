...
public class InstanceID {
    ...
    static String zza(KeyPair keyPair) {
        try {
            ...
            digest[0] = (byte) (((digest[0] & 15) + C0308R.styleable.AppCompatTheme_spinnerStyle) & MotionEventCompat.ACTION_MASK);
    ...
    public void zzb(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("subtype", BuildConfig.FLAVOR.equals(this.zzbhe) ? str : this.zzbhe);
        String str3 = "X-subtype";
        if (!BuildConfig.FLAVOR.equals(this.zzbhe)) {
            str = this.zzbhe;
        }
    ...
    public String zzc(String str, String str2, Bundle bundle) throws IOException {
        ...
        bundle.putString("sender", str);
        String str3 = BuildConfig.FLAVOR.equals(this.zzbhe) ? str : this.zzbhe;
