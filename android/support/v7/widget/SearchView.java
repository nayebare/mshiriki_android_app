...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03784 implements OnFocusChangeListener {
        C03784() {
        }
    ...
    class C03795 implements OnLayoutChangeListener {
        C03795() {
        }
    ...
    class C03806 implements OnGlobalLayoutListener {
        C03806() {
        }
    ...
    class C03817 implements OnClickListener {
        C03817() {
        }
    ...
    class C03828 implements OnKeyListener {
        C03828() {
        }
    ...
    class C03839 implements OnEditorActionListener {
        C03839() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C03841());
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0283R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0283R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C03751();
        this.mUpdateDrawableStateRunnable = new C03762();
        this.mReleaseCursorRunnable = new C03773();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03817();
        this.mTextKeyListener = new C03828();
        this.mOnEditorActionListener = new C03839();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0283R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0283R.styleable.SearchView_layout, C0283R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0283R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0283R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0283R.id.search_plate);
        this.mSubmitArea = findViewById(C0283R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0283R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0283R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0283R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0283R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0283R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0283R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0283R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0283R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0283R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0283R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0283R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0283R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0283R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0283R.styleable.SearchView_suggestionRowLayout, C0283R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0283R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03784());
        setIconifiedByDefault(a.getBoolean(C0283R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0283R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0283R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0283R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0283R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0283R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0283R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C03795());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C03806());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0283R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0283R.dimen.abc_search_view_preferred_height);
    }
    ...
    private void updateSearchAutoComplete() {
        ...
        if ((inputType & 15) == 1) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                inputType = (inputType | ExecutionOptions.MAX_TRACKING_TAG_STRING_LENGTH) | AccessibilityNodeInfoCompat.ACTION_COLLAPSE;
            }
        }
        this.mSearchSrcTextView.setInputType(inputType);
    ...
    public void onActionViewCollapsed() {
        setQuery(BuildConfig.FLAVOR, DBG);
        clearFocus();
        updateViewsVisibility(true);
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0283R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0283R.dimen.abc_dropdownitem_text_padding_left) : 0;
