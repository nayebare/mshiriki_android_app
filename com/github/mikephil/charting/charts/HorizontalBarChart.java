...
public class HorizontalBarChart extends BarChart {
    ...
    public void calculateOffsets() {
        ...
        if (this.mLegend != null && this.mLegend.isEnabled()) {
            if (this.mLegend.getPosition() == LegendPosition.RIGHT_OF_CHART || this.mLegend.getPosition() == LegendPosition.RIGHT_OF_CHART_CENTER) {
                ...
                offsetBottom = 0.0f + Math.min(this.mLegend.mNeededHeight + (this.mLegend.mTextHeightMax * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT), this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent());
                ...
                offsetTop = 0.0f + Math.min(this.mLegend.mNeededHeight + (this.mLegend.mTextHeightMax * ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT), this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent());
            }
        }
    ...
    public int getLowestVisibleXIndex() {
        ...
        return (int) (f + TextTrackStyle.DEFAULT_FONT_SCALE);
    }
