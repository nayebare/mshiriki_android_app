...
public class zzbfk {
    ...
    public zzbfk() {
        this.zzbDw = "https://www.google-analytics.com";
    }
    ...
    String zzc(zzbfa com_google_android_gms_internal_zzbfa) {
        ...
        String trim = !com_google_android_gms_internal_zzbfa.zzRf().trim().equals(BuildConfig.FLAVOR) ? com_google_android_gms_internal_zzbfa.zzRf().trim() : "-1";
