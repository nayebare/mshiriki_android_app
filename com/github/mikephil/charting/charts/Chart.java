...
public abstract class Chart<T extends ChartData<? extends DataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    class C04651 implements AnimatorUpdateListener {
        C04651() {
        }
    ...
    public Chart(Context context) {
        ...
        this.mDeltaX = TextTrackStyle.DEFAULT_FONT_SCALE;
    ...
    protected void init() {
        ...
        if (VERSION.SDK_INT < PAINT_DESCRIPTION) {
            ...
            this.mAnimator = new ChartAnimator(new C04651());
        }
    ...
    public void setDragDecelerationFrictionCoef(float newValue) {
        ...
        if (newValue >= TextTrackStyle.DEFAULT_FONT_SCALE) {
            newValue = 0.999f;
        }
    ...
    public PointF getCenter() {
        return new PointF(((float) getWidth()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT, ((float) getHeight()) / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    }
