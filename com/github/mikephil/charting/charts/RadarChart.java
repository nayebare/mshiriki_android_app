...
public class RadarChart extends PieRadarChartBase<RadarData> {
    ...
    public float getFactor() {
        ...
        return Math.min(content.width() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT, content.height() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) / this.mYAxis.mAxisRange;
    }
    ...
    public int getIndexForAngle(float angle) {
        ...
        for (int i = 0; i < ((RadarData) this.mData).getXValCount(); i++) {
            if ((((float) (i + 1)) * sliceangle) - (sliceangle / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT) > a) {
                return i;
            }
        }
        return 0;
    ...
    public float getRadius() {
        RectF content = this.mViewPortHandler.getContentRect();
        return Math.min(content.width() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT, content.height() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT);
    }
