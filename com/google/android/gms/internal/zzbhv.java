...
public interface zzbhv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbhv {

        private static class zza implements zzbhv {
        ...
        public static zzbhv zzfm(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbhv)) ? new zza(iBinder) : (zzbhv) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case MessageApi.FILTER_PREFIX /*1*/:
                    ...
                    zza(com.google.android.gms.dynamic.zzd.zza.zzcd(parcel.readStrongBinder()), parcel.readInt() != 0 ? (WalletFragmentOptions) WalletFragmentOptions.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
