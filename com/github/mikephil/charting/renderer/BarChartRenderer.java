    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight h : indices) {
            ...
            if (set != null && set.isHighlightEnabled()) {
                float barspaceHalf = set.getBarSpace() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
                ...
                if (index >= 0) {
                    if (((float) index) < (this.mChart.getXChartMax() * this.mAnimator.getPhaseX()) / ((float) setCount)) {
                        ...
                        if (e != null && e.getXIndex() == index) {
                            ...
                            float x = (((float) ((index * setCount) + dataSetIndex)) + (groupspace / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT)) + (((float) index) * groupspace);
                            ...
                            if (this.mChart.isDrawHighlightArrowEnabled()) {
                                ...
                                float arrowWidth = set.getBarSpace() / ImageRequest.DEFAULT_IMAGE_BACKOFF_MULT;
