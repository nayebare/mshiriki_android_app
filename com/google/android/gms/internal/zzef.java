...
public final class zzef {
    ...
    private final AdSize[] zzzr;

    public zzef(Context context, AttributeSet attributeSet) {
        Object obj = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0473R.styleable.AdsAttrs);
        Object string = obtainAttributes.getString(C0473R.styleable.AdsAttrs_adSize);
        Object string2 = obtainAttributes.getString(C0473R.styleable.AdsAttrs_adSizes);
        Object obj2 = !TextUtils.isEmpty(string) ? 1 : null;
        if (TextUtils.isEmpty(string2)) {
            obj = null;
        }
        if (obj2 != null && r1 == null) {
            this.zzzr = zzK(string);
        } else if (obj2 == null && r1 != null) {
            this.zzzr = zzK(string2);
        } else if (obj2 != null) {
            throw new IllegalArgumentException("Either XML attribute \"adSize\" or XML attribute \"supportedAdSizes\" should be specified, but not both.");
        } else {
            throw new IllegalArgumentException("Required XML attribute \"adSize\" was missing.");
        }
        this.zztq = obtainAttributes.getString(C0473R.styleable.AdsAttrs_adUnitId);
