...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ACTION_FOCUS = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_CHARACTER, null);
            ACTION_CLEAR_FOCUS = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_WORD, null);
            ACTION_SELECT = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_LINE, null);
            ACTION_CLEAR_SELECTION = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_PARAGRAPH, null);
            ACTION_CLICK = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.MOVEMENT_GRANULARITY_PAGE, null);
            ACTION_LONG_CLICK = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_LONG_CLICK, null);
            ACTION_ACCESSIBILITY_FOCUS = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_ACCESSIBILITY_FOCUS, null);
            ACTION_CLEAR_ACCESSIBILITY_FOCUS = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, null);
            ACTION_NEXT_AT_MOVEMENT_GRANULARITY = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, null);
            ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY, null);
            ACTION_NEXT_HTML_ELEMENT = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT, null);
            ACTION_PREVIOUS_HTML_ELEMENT = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_PREVIOUS_HTML_ELEMENT, null);
            ACTION_SCROLL_FORWARD = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD, null);
            ACTION_SCROLL_BACKWARD = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD, null);
            ACTION_COPY = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_COPY, null);
            ACTION_PASTE = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_PASTE, null);
            ACTION_CUT = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_CUT, null);
            ACTION_SET_SELECTION = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_SET_SELECTION, null);
            ACTION_EXPAND = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_EXPAND, null);
            ACTION_COLLAPSE = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_COLLAPSE, null);
            ACTION_DISMISS = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_DISMISS, null);
            ACTION_SET_TEXT = new AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_SET_TEXT, null);
