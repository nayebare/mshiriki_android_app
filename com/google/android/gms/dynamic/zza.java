...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    class C06541 implements zzf<T> {
        final /* synthetic */ zza zzaQh;

        C06541(zza com_google_android_gms_dynamic_zza) {
    ...
    class C06552 implements zza {
        final /* synthetic */ Activity val$activity;
        final /* synthetic */ zza zzaQh;
        final /* synthetic */ Bundle zzaQi;
        final /* synthetic */ Bundle zzxd;

        C06552(zza com_google_android_gms_dynamic_zza, Activity activity, Bundle bundle, Bundle bundle2) {
            this.zzaQh = com_google_android_gms_dynamic_zza;
    ...
    class C06563 implements zza {
        final /* synthetic */ zza zzaQh;
        final /* synthetic */ Bundle zzxd;

        C06563(zza com_google_android_gms_dynamic_zza, Bundle bundle) {
            this.zzaQh = com_google_android_gms_dynamic_zza;
            this.zzxd = bundle;
        }
    ...
    class C06574 implements zza {
        ...
        C06574(zza com_google_android_gms_dynamic_zza, FrameLayout frameLayout, LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            this.zzaQh = com_google_android_gms_dynamic_zza;
    ...
    class C06585 implements OnClickListener {
        final /* synthetic */ Intent zzaQm;
        final /* synthetic */ Context zztd;

        C06585(Context context, Intent intent) {
            this.zztd = context;
            this.zzaQm = intent;
        }
    ...
    class C06596 implements zza {
        final /* synthetic */ zza zzaQh;

        C06596(zza com_google_android_gms_dynamic_zza) {
            this.zzaQh = com_google_android_gms_dynamic_zza;
        }
    ...
    class C06607 implements zza {
        final /* synthetic */ zza zzaQh;

        C06607(zza com_google_android_gms_dynamic_zza) {
            this.zzaQh = com_google_android_gms_dynamic_zza;
        }
    ...
    static void zza(FrameLayout frameLayout, GoogleApiAvailability googleApiAvailability) {
        ...
        if (zzb != null) {
            ...
            button.setOnClickListener(new C06585(context, zzb));
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        zza(bundle, new C06563(this, bundle));
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        FrameLayout frameLayout = new FrameLayout(layoutInflater.getContext());
        zza(bundle, new C06574(this, frameLayout, layoutInflater, viewGroup, bundle));
        if (this.zzaQd == null) {
            zza(frameLayout);
        }
        return frameLayout;
    ...
    public void onInflate(Activity activity, Bundle bundle, Bundle bundle2) {
        zza(bundle2, new C06552(this, activity, bundle, bundle2));
    }
