...
public class AppBarLayout extends LinearLayout {
    ...
    class C00101 implements OnApplyWindowInsetsListener {
        C00101() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        class C00111 implements AnimatorUpdateListener {
            ...
            C00111(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            static class C00121 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C00121() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C00121());
            }
        }
        ...
        private void animateOffsetWithDuration(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset, int duration) {
            ...
            if (currentOffset != offset) {
                if (this.mOffsetAnimator == null) {
                    ...
                    this.mOffsetAnimator.addUpdateListener(new C00111(coordinatorLayout, child));
                } else {
                    this.mOffsetAnimator.cancel();
                }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        a.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00101());
    }
