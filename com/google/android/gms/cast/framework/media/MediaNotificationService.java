...
public class MediaNotificationService extends Service {
    ...
    static {
        zzaoQ = new zzyu("MediaNotificationService");
    }
    ...
    public void onCreate() {
        this.zzaqQ = zzwq.zza(this, CastContext.getSharedInstance(this).zzsg(), zze.zzA(null), CastContext.getSharedInstance(this).getCastOptions().getCastMediaOptions());
        try {
            this.zzaqQ.onCreate();
        } catch (Throwable e) {
