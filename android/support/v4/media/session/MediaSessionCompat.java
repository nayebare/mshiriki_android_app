...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends Stub {
            ...
            public void sendCommand(String command, Bundle args, ResultReceiverWrapper cb) {
                MediaSessionImplBase.this.postToHandler((int) MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS, new Command(command, args, cb.mResultReceiver));
            }
            ...
            public void prepareFromMediaId(String mediaId, Bundle extras) throws RemoteException {
                MediaSessionImplBase.this.postToHandler((int) MediaSessionCompat.FLAG_HANDLES_QUEUE_COMMANDS, (Object) mediaId, extras);
            }
        ...
        PlaybackStateCompat getStateWithUpdatedPosition() {
            ...
            if (state != null && (state.getState() == 3 || state.getState() == MediaSessionCompat.FLAG_HANDLES_QUEUE_COMMANDS || state.getState() == 5)) {
