...
public class zzbfo implements Runnable {
    ...
    boolean zzRq() {
        if (!zzbV("android.permission.INTERNET")) {
            zzayx.m23e("Missing android.permission.INTERNET. Please add the following declaration to your AndroidManifest.xml: <uses-permission android:name=\"android.permission.INTERNET\" />");
            return false;
            ...
            zzayx.m23e("Missing android.permission.ACCESS_NETWORK_STATE. Please add the following declaration to your AndroidManifest.xml: <uses-permission android:name=\"android.permission.ACCESS_NETWORK_STATE\" />");
            return false;
        }
    }
    ...
    void zzgq() {
        if (zzRq()) {
            String zzb;
            String valueOf;
            zzayx.m24v("Starting to load resource from Network.");
