...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C03531 implements OnAttachStateChangeListener {
        C03531() {
        }
    ...
    class C03542 implements OnGlobalLayoutListener {
        boolean mIsAttached;
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C03531());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C03542());
    }
