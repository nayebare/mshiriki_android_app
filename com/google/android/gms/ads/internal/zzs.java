...
public class zzs {
    ...
    class C05251 implements Runnable {
        ...
        C05251(zzs com_google_android_gms_ads_internal_zzs, WeakReference weakReference) {
            this.zzul = com_google_android_gms_ads_internal_zzs;
            this.zzuk = weakReference;
        }

        public void run() {
            this.zzul.zzuh = false;
            zza com_google_android_gms_ads_internal_zza = (zza) this.zzuk.get();
    ...
    zzs(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzs_zza) {
        ...
        this.zzv = new C05251(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
