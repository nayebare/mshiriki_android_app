...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    class C03201 implements OnGlobalLayoutListener {
        C03201() {
        }
    ...
    class C03222 implements MenuItemHoverListener {
        ...
        class C03211 implements Runnable {
            ...
            C03211(CascadingMenuInfo cascadingMenuInfo, MenuItem menuItem, MenuBuilder menuBuilder) {
        ...
        public void onItemHoverEnter(@NonNull MenuBuilder menu, @NonNull MenuItem item) {
            ...
            if (menuIndex != -1) {
                ...
                CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new C03211(nextInfo, item, menu), menu, SystemClock.uptimeMillis() + 200);
            }
        }
    }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mGlobalLayoutListener = new C03201();
        this.mMenuItemHoverListener = new C03222();
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0283R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            ...
            View titleItemView = (FrameLayout) inflater.inflate(C0283R.layout.abc_popup_menu_header_item_layout, listView, false);
