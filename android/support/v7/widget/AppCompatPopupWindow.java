...
class AppCompatPopupWindow extends PopupWindow {
    ...
    static class C03371 implements OnScrollChangedListener {
        ...
        C03371(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0283R.styleable.PopupWindow, defStyleAttr, defStyleRes);
        if (a.hasValue(C0283R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(C0283R.styleable.PopupWindow_overlapAnchor, COMPAT_OVERLAP_ANCHOR));
        }
        setBackgroundDrawable(a.getDrawable(C0283R.styleable.PopupWindow_android_popupBackground));
        int sdk = VERSION.SDK_INT;
        if (defStyleRes != 0 && sdk < 11 && a.hasValue(C0283R.styleable.PopupWindow_android_popupAnimationStyle)) {
            setAnimationStyle(a.getResourceId(C0283R.styleable.PopupWindow_android_popupAnimationStyle, -1));
        }
        a.recycle();
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popup) {
        try {
            ...
            fieldListener.set(popup, new C03371(fieldAnchor, popup, (OnScrollChangedListener) fieldListener.get(popup)));
        } catch (Exception e) {
