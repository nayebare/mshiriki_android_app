...
public class DiffUtil {
    ...
    static class C03131 implements Comparator<Snake> {
        C03131() {
        }
    ...
    public static class DiffResult {
        ...
        class C03141 implements ListUpdateCallback {
            final /* synthetic */ Adapter val$adapter;

            C03141(Adapter adapter) {
        ...
        public void dispatchUpdatesTo(Adapter adapter) {
            dispatchUpdatesTo(new C03141(adapter));
        }
