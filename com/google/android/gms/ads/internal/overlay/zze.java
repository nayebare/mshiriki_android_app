...
public class zze extends com.google.android.gms.internal.zzkr.zza implements zzv {
    ...
    class C04891 implements com.google.android.gms.internal.zzqq.zza {
        C04891(zze com_google_android_gms_ads_internal_overlay_zze) {
        }
    ...
    class C04902 implements Runnable {
        ...
        C04902(zze com_google_android_gms_ads_internal_overlay_zze) {
    ...
    private class zzd extends zzpd {
        ...
        class C04911 implements Runnable {
            final /* synthetic */ Drawable zzMU;
            final /* synthetic */ zzd zzMV;

            C04911(zzd com_google_android_gms_ads_internal_overlay_zze_zzd, Drawable drawable) {
                this.zzMV = com_google_android_gms_ads_internal_overlay_zze_zzd;
                this.zzMU = drawable;
            }

            public void run() {
                this.zzMV.zzMR.mActivity.getWindow().setBackgroundDrawable(this.zzMU);
            }
        }
        ...
        public void zzcm() {
            ...
            if (zza != null) {
                zzpi.zzWR.post(new C04911(this, zzv.zzcL().zza(this.zzMR.mActivity, zza, this.zzMR.zzMy.zzNi.zztK, this.zzMR.zzMy.zzNi.zztL)));
            }
        }
    }

    static {
        zzMx = Color.argb(0, 0, 0, 0);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            this.zzMG.setId(CardNetwork.OTHER);
    ...
    protected void zzA(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzGt.zzkV().zza(new C04891(this));
            if (this.zzMy.url != null) {
                this.zzGt.loadUrl(this.zzMy.url);
            } else if (this.zzMy.zzNd != null) {
                this.zzGt.loadDataWithBaseURL(this.zzMy.zzNb, this.zzMy.zzNd, "text/html", HTTP.UTF_8, null);
            } else {
