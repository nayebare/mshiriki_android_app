...
public class zzbgt extends zzbhc<zzbgy> {
    ...
    private Landmark zza(zzbha com_google_android_gms_internal_zzbha) {
        return new Landmark(new PointF(com_google_android_gms_internal_zzbha.f25x, com_google_android_gms_internal_zzbha.f26y), com_google_android_gms_internal_zzbha.type);
    }
