...
public class PopupMenu {
    ...
    class C03631 implements Callback {
        C03631() {
        }
    ...
    class C03642 implements android.widget.PopupWindow.OnDismissListener {
        C03642() {
        }
    ...
    class C03653 extends ForwardingListener {
        C03653(View src) {
            super(src);
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0283R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C03631());
        ...
        this.mPopup.setOnDismissListener(new C03642());
    }
    ...
    public OnTouchListener getDragToOpenListener() {
        if (this.mDragListener == null) {
            this.mDragListener = new C03653(this.mAnchor);
        }
