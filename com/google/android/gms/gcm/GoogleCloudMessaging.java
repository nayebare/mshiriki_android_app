...
public class GoogleCloudMessaging {
    ...
    class C08621 extends Handler {
        final /* synthetic */ GoogleCloudMessaging zzbgf;

        C08621(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzbge = new Messenger(new C08621(this, Looper.getMainLooper()));
    }
    ...
    private String zzeI(String str) {
        ...
        return InstanceID.getInstance(this.zzqr).zzGv().zzh(BuildConfig.FLAVOR, str, INSTANCE_ID_SCOPE);
    }
    ...
    Intent zzJ(Bundle bundle) throws IOException {
        if (Looper.getMainLooper() == Looper.myLooper()) {
            ...
            try {
                return (Intent) this.zzbgd.poll(NotificationOptions.SKIP_STEP_THIRTY_SECONDS_IN_MS, TimeUnit.MILLISECONDS);
